...
class Ldap {
   ...
   * Constructor.
   *
   * @param  array|Traversable $options Options used in connecting, binding,
   *   etc.
   *
   ...
   * ACCTNAME_FORM_USERNAME indicating the form usernames should be
   *   canonicalized to.
   */
   ...
   * @param  int $networkTimeout The value for network timeout when connect to
   *   the LDAP server.
   *
   * @return Ldap Provides a fluent interface
   * @throws Exception\LdapException
