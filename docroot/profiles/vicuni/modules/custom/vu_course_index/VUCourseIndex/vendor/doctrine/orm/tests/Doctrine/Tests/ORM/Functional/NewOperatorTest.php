...
class NewOperatorTest extends \Doctrine\Tests\OrmFunctionalTestCase {
   ...
   *   '\InvalidClass(u.name)': Error: Class "\InvalidClass" is not defined.
   */
   ...
   * @expectedException Doctrine\ORM\Query\QueryException
   * @expectedExceptionMessage [Semantical Error] line 0, col 11 near
   *   '\stdClass(u.name)': Error: Class "\stdClass" has not a valid
   *   constructor.
   */
   ...
   * @expectedException Doctrine\ORM\Query\QueryException
   * @expectedExceptionMessage [Semantical Error] line 0, col 11 near
   *   'Doctrine\Tests\ORM\Functional\ClassWithTooMuchArgs(u.name)': Error:
   *   Number of arguments does not match with
   *   "Doctrine\Tests\ORM\Functional\ClassWithTooMuchArgs" constructor
   *   declaration.
   */
   ...
   * @expectedException Doctrine\ORM\Query\QueryException
   * @expectedExceptionMessage [Semantical Error] line 0, col 11 near
   *   'Doctrine\Tests\ORM\Functional\ClassWithPrivateConstructor(u.name)':
   *   Error: Class "Doctrine\Tests\ORM\Functional\ClassWithPrivateConstructor"
