 ...
 * While RFC 1945 requires an absolute URI, most of the browsers also support
 *   relative URI This class allows relative URIs, and let user retrieve URI
 *   instance if strict validation needed
 */
abstract class AbstractDate implements HeaderInterface {
   ...
   * RFC 1036 and ANSI C formats are provided for compatibility with old
   * servers/clients
   *
   * @link http://www.w3.org/Protocols/rfc2616/rfc2616-sec3.html#sec3.3
   *
   ...
   * Returns < 0 if date in header is less than $date; > 0 if it's greater, and
   * 0 if they are equal.
   *
   * @see \strcmp()
   *
