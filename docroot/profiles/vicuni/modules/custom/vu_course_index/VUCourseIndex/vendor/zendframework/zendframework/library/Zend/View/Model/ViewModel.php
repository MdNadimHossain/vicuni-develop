...
class ViewModel implements ModelInterface, ClearableModelInterface, RetrievableChildrenInterface {
   ...
   * @param  mixed|null $default (optional) A default value if the option is
   *   not yet set.
   *
   * @return mixed
   */
   ...
   *
   * @param  string $name
   * @param  mixed|null $default (optional) default value if the variable is
   *   not present.
   *
   * @return mixed
   */
   ...
   * @param  bool $overwrite Whether or not to overwrite the internal container
   *   with $variables
   *
   ...
   * @param  null|string $captureTo Optional; if specified, the "capture to"
   *   value to set on the child
   * @param  null|bool $append Optional; if specified, append to child  with
   *   the same capture
   *
   * @return ViewModel
   */
