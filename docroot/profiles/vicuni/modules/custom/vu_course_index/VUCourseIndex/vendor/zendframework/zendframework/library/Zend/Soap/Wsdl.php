...
class Wsdl {
   ...
   * @param  null|ComplexTypeStrategy $strategy Strategy for detection of
   *   complex types
  ...
  /**
   * Add a {@link http://www.w3.org/TR/wsdl#_messages message} element to the
   * WSDL
   *
   * @param  string $messageName Name for the {@link
   *   http://www.w3.org/TR/wsdl#_messages message}
   * @param  array $parts An array of {@link http://www.w3.org/TR/wsdl#_message
   *   parts} The array is constructed like:
   *                          'name of part' => 'part xml schema data type' or
   *                          'name of part' => array('type' => 'part xml
   *   schema type')  or
   *                          'name of part' => array('element' => 'part xml
   *   element name')
   *
   * @return DOMElement The new message's XML_Tree_Node for use in {@link
  ...
  /**
   * Add a {@link http://www.w3.org/TR/wsdl#_porttypes portType} element to the
   * WSDL
   *
   * @param  string $name portType element's name
   *
   * @return DOMElement The new portType's XML_Tree_Node for use in {@link
   *   function addPortOperation} and <a
   *   href='psi_element://function'>addDocumentation</a>@link function
   *   addDocumentation}
   */
  ...
  /**
   * Add an {@link http://www.w3.org/TR/wsdl#request-response operation}
   * element to a portType element
   *
   * @param  DOMElement $portType a portType XML_Tree_Node, from {@link
   ...
   *
   * @return DOMElement The new operation's XML_Tree_Node for use in {@link
   *   function addDocumentation}
   */
   ...
   *
   * @return DOMElement The new binding's XML_Tree_Node for use with {@link
   *   function addBindingOperation} and {@link function addDocumentation}
   */
   ...
   *
   * @param  DOMElement $binding A binding XML_Tree_Node returned by {@link
   *   function addBinding}
   * @param  string $name
   * @param  array|bool $input An array of attributes for the input element,
   *                            allowed keys are: 'use', 'namespace',
   *   'encodingStyle'.
   ...
   *                            allowed keys are: 'name', 'use', 'namespace',
   *   'encodingStyle'.
   *                            {@link http://www.w3.org/TR/wsdl#_soap:body
   *   More Information}
   * @param  int $soapVersion SOAP version: SOAP_1_1 or SOAP_1_2, default:
   *   SOAP_1_1
   *
  ...
  /**
   * Add a {@link http://www.w3.org/TR/wsdl#_soap:binding SOAP binding} element
   * to a Binding element
   *
   * @param  DOMElement $binding A binding XML_Tree_Node returned by {@link
   *   function addBinding}
   * @param  string $style binding style, possible values are "rpc" (the
  ...
  /**
   * Add a {@link http://www.w3.org/TR/wsdl#_soap:operation SOAP operation} to
   * an operation element
   *
   * @param  DOMElement $operation An operation XML_Tree_Node returned by
   *   {@link function addBindingOperation}
  ...
  /**
   * Add a {@link http://www.w3.org/TR/wsdl#_services service} element to the
   * WSDL
   *
   ...
   *   SOAP_1_1
   *
   * @return DOMElement The new service's XML_Tree_Node for use with {@link
   *   function addDocumentation}
   */
   ...
   *
   * Note that the WSDL {@link http://www.w3.org/TR/wsdl#_documentation
   * specification} uses 'document', but the WSDL {@link
   * http://schemas.xmlsoap.org/wsdl/ schema} uses 'documentation' instead. The
   * {@link
   * http://www.ws-i.org/Profiles/BasicProfile-1.1-2004-08-24.html#WSDL_documentation_Element
   * WS-I Basic Profile 1.1} recommends using 'documentation'.
   *
   * @param  DOMElement $inputNode An XML_Tree_Node returned by another method
   *   to add the documentation to
  ...
  /**
   * Add a complex type name that is part of this WSDL and can be used in
   * signatures.
   *
   * @param  string $type
  ...
  /**
   * This function makes sure a complex types section and schema additions are
   * set.
   *
   * @return self
   */
  ...
  /**
   * Convert associative array to attributes of given node using optional
   * {@link function sanitizeAttributeValueByName}
   *
   * @param  DOMNode $node
  ...
  /**
   * Set attribute to given node using {@link function
   ...
   * The 'sequence', 'all' and 'choice' keys must have an array of elements as
   * their value, to add them to a nested complexType.
   *
   * Example: array( 'name' => 'MyElement',
   *                 'sequence' => array( array('name' => 'myString', 'type' =>
   * 'string'), array('name' => 'myInteger', 'type' => 'int') ) ); Resulting
   * XML: <xsd:element name="MyElement"><xsd:complexType><xsd:sequence>
