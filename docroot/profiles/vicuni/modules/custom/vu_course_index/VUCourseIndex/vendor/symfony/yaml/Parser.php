...
class Parser {
   ...
   * Constructor.
   *
   * @param int $offset The offset of YAML document (used for line numbers in
   *   error messages)
   */
   ...
   *   invalid types (a PHP resource or object), false otherwise
   * @param bool $objectSupport true if object support is enabled, false
   *   otherwise
   * @param bool $objectForMap true if maps should return a stdClass instead of
   *   array()
   *
   ...
   *
   * @param int $indentation The indent level at which the block is to be read,
   *   or null for default
   ...
   *
   * @param string $style The style indicator that was used to begin this block
   *   scalar (| or >)
   ...
   *
   * @return bool Returns true if the current line is a comment line, false
   *   otherwise
   */
   ...
   *
   * @return bool Returns true if the next line starts unindented collection,
   *   false otherwise
   */
   ...
   *
   * @return bool Returns true if the string is un-indented collection item,
   *   false otherwise
   */
