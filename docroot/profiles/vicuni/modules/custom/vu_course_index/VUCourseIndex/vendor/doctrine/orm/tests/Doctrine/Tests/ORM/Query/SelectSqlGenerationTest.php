...
class SelectSqlGenerationTest extends \Doctrine\Tests\OrmTestCase {
  ...
  public function testSupportsMemberOfExpressionSelfReferencing() {
    ...
    $this->_em->getClassMetadata(get_class($person))
      ->setIdentifierValues($person, array('id' => 101));
  ...
  public function testBooleanLiteralInWhereOnSqlite() {
    ...
    $this->_em->getConnection()
      ->setDatabasePlatform(new \Doctrine\DBAL\Platforms\SqlitePlatform);
  ...
  public function testPessimisticWriteLockQueryHint() {
    if ($this->_em->getConnection()
        ->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\SqlitePlatform
    ) {
  ...
  public function testPessimisticReadLockQueryHintOracle() {
    $this->_em->getConnection()
      ->setDatabasePlatform(new \Doctrine\DBAL\Platforms\OraclePlatform);
