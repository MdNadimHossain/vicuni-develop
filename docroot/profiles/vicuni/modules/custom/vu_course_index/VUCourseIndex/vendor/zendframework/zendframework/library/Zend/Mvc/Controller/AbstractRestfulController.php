...
abstract class AbstractRestfulController extends AbstractController {
   ...
   *
   * @return mixed
   * @throws Exception\DomainException if no route matches in event or invalid
   *   HTTP method
   */
   ...
   *
   * To retrieve the body content data, use "$data =
   * $this->processBodyContent($request)"; that method will return a string,
   * array, or, in the case of JSON, an object.
   *
   * @param  string $method
