...
class OraclePlatformTest extends AbstractPlatformTestCase {
  ...
  public function getGeneratesAdvancedForeignKeyOptionsSQLData() {
    return array(
      ...
      array(
        array('onUpdate' => 'SET NULL', 'onDelete' => 'SET NULL'),
        ' ON DELETE SET NULL'
      ),
    );
  }
  ...
  public function testAlterTableNotNULL() {
    ...
    $tableDiff->changedColumns['foo'] = new \Doctrine\DBAL\Schema\ColumnDiff(
      ...
      'foo', \Doctrine\DBAL\Types\Type::getType('string'), array(
        'default' => 'bla',
        'notnull' => TRUE
      )
    ),
    ...
    $tableDiff->changedColumns['bar'] = new \Doctrine\DBAL\Schema\ColumnDiff(
      ...
      'baz', \Doctrine\DBAL\Types\Type::getType('string'), array(
        'default' => 'bla',
        'notnull' => TRUE
      )
    ),
    ...
    $tableDiff->changedColumns['metar'] = new \Doctrine\DBAL\Schema\ColumnDiff(
      ...
      'metar', \Doctrine\DBAL\Types\Type::getType('string'), array(
        'length' => 2000,
        'notnull' => FALSE
      )
    ),
  ...
  public function testReturnsBinaryTypeDeclarationSQL() {
    ...
    $this->assertSame('RAW(2000)', $this->_platform->getBinaryTypeDeclarationSQL(array(
      'fixed' => TRUE,
      'length' => 0
    )));
    $this->assertSame('RAW(2000)', $this->_platform->getBinaryTypeDeclarationSQL(array(
