...
/**
 * Please note there are two standalone test scripts for testing IDN characters
 * due to problems with file encoding.
 *
 * The first is tests/Zend/Validator/HostnameTestStandalone.php which is
 * designed to be run on the command line.
 *
 * The second is tests/Zend/Validator/HostnameTestForm.php which is designed to
 * be run via HTML to allow users to test entering UTF-8 characters in a form.
 */
class Hostname extends AbstractValidator {
   ...
   *
   * @see ftp://data.iana.org/TLD/tlds-alpha-by-domain.txt  List of all TLDs by
   *   domain
   ...
   *
   * @see http://www.iana.org/domains/idn-tables/ Official list of supported
   *   IDN Chars
   ...
   * (.AT) Austria
   *   http://www.nic.at/en/service/technical_information/idn/charset_converter/
   * (.BIZ) International http://www.iana.org/domains/idn-tables/
   * (.BR) Brazil http://registro.br/faq/faq6.html
   * (.BV) Bouvett Island
   *   http://www.norid.no/domeneregistrering/idn/idn_nyetegn.en.html
   * (.CAT) Catalan
   *   http://www.iana.org/domains/idn-tables/tables/cat_ca_1.0.html
   * (.CH) Switzerland
   ...
   * (.HU) Hungary
   *   http://www.domain.hu/domain/English/szabalyzat/szabalyzat.html
   ...
   *   http://www.iana.org/domains/idn-tables/tables/museum_latn_1.0.html
   * (.NET) International
   *   http://www.verisign.com/information-services/naming-services/internationalized-domain-names/index.html
   * (.NO) Norway
   *   http://www.norid.no/domeneregistrering/idn/idn_nyetegn.en.html
   ...
   * (.ORG) International
   *   http://www.pir.org/index.php?db=content/FAQs&tbl=FAQs_Registrant&id=2
   ...
   *   http://www.norid.no/domeneregistrering/idn/idn_nyetegn.en.html
   * (.TH) Thailand
   *   http://www.iana.org/domains/idn-tables/tables/th_th-th_1.0.html
   * (.TM) Turkmenistan http://www.nic.tm/TM-IDN-Policy.pdf
   * (.TR) Turkey https://www.nic.tr/index.php
   * (.UA) Ukraine
   *   http://www.iana.org/domains/idn-tables/tables/ua_cyrl_1.2.html
   * (.VE) Venice http://www.iana.org/domains/idn-tables/tables/ve_es_1.0.html
   * (.VN) Vietnam
   *   http://www.vnnic.vn/english/5-6-300-2-2-04-20071115.htm#1.%20Introduction
   *
   * @var array
   */
   ...
   *
   * @param int $allow OPTIONAL Set what types of hostname to allow (default
   *   ALLOW_DNS)
   * @param bool $useIdnCheck OPTIONAL Set whether IDN domains are validated
   *   (default true)
   * @param bool $useTldCheck Set whether the TLD element of a hostname is
   ...
   *
   * Returns true if and only if the $value is a valid hostname with respect to
   * the current allow option
   *
   * @param  string $value
   *
   * @return bool
