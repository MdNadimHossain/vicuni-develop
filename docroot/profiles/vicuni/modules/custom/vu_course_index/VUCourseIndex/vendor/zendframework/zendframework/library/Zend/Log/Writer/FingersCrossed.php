...
class FingersCrossed extends AbstractWriter {
   ...
   * Constructor
   *
   * @param WriterInterface|string|array|Traversable $writer Wrapped writer or
   *   array of configuration options
   * @param FilterInterface|int $filterOrPriority Filter or log priority which
   *   determines buffering of events
