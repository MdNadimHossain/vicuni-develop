...
class Application {
   ...
   *
   * @param bool $boolean Whether to catch exceptions or not during commands
   *   execution
   */
   ...
   *
   * @param bool $boolean Whether to automatically exit after a command
   *   execution or not
   */
   ...
   *
   * @throws CommandNotFoundException When command name is incorrect or
   *   ambiguous
   */
  ...
  protected function configureIO(InputInterface $input, OutputInterface $output) {
    ...
    elseif (function_exists('posix_isatty') && $this->getHelperSet()
        ->has('question')
    ) {
