...
class AutoDiscover {
   ...
   *
   * By default 'style' is 'rpc' and 'transport' is
  ...
  /**
   * Set the strategy that handles functions and classes that are added AFTER
   * this call.
   *
  ...
  protected function _generateClass() {
    return $this->_generateWsdl($this->reflection->reflectClass($this->class)
      ->getMethods());
  }
