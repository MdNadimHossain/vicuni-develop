...
class Entry {
   ...
   * @param array $author
   *
   * @throws Exception\InvalidArgumentException If any value of $author not
   *   follow the format.
   * @return Entry
   */
   ...
   * keys 'uri', 'type' and 'length'. Only 'uri' is required for Atom, though
   * the others must also be provided or RSS rendering (where they are
   * required) will throw an Exception.
   *
   ...
   *
   * @return mixed
   * @throws Exception\BadMethodCallException if no extensions implements the
   *   method
   */
