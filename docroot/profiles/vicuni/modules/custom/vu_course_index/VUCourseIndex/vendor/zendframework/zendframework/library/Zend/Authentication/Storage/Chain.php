...
class Chain implements StorageInterface {
   ...
   *
   * In case a non-empty storage is found then this chain storage is also
   * non-empty. Report that, but also make sure that all storage with higher
   * priorty that are empty are filled.
   *
  ...
  /**
   * If the chain is non-empty then the storage with the top priority is
   * guaranteed to be filled. Return its value.
   *
