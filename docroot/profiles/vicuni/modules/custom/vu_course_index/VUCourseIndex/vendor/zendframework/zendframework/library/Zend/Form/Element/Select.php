...
class Select extends Element implements InputProviderInterface {
  ...
  /**
   * Create an empty option (option with label but no value). If set to null,
   * no option is created
   *
   * @var bool
   */
  ...
  /**
   * Set the flag to allow for disabling the automatic addition of an InArray
   * validator.
   *
  ...
  /**
   * Set the string for an empty option (can be empty string). If set to null,
