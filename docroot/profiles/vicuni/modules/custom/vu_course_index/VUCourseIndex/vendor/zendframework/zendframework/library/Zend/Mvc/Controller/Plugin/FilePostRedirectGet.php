...
class FilePostRedirectGet extends AbstractPlugin {
  ...
  /**
   * Traverse the InputFilter and run a callback against each Input and
   * associated value
   *
  ...
  /**
   * Traverse the InputFilter and only return the data of FileInputs that have
   * an upload
   *
   * @param  InputFilterInterface $inputFilter
   * @param  array $data
  ...
  /**
   * Traverse the InputFilter and only return the data of FileInputs that are
   * empty
   *
   * @param  InputFilterInterface $inputFilter
   * @param  array $data
  ...
  /**
   * TODO: Good candidate for traits method in PHP 5.4 with PostRedirectGet
   * plugin
   *
