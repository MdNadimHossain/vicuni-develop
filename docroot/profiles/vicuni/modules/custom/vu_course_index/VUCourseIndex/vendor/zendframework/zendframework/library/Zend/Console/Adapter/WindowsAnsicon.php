 ...
 *
 * This adapter requires ANSICON extension to be installed. It can be obtained
 * from: https://github.com/adoxa/ansicon
 *
 * ANSICON has to be loaded and enabled before using this adapter. It's best to
 * install it using following command: ansicon -I
 *
 * Console should not run in UTF8 code page (65001), because ANSICON does not
 * behave well with it. It's best to use non-unicode code page 437, 850, 851,
 * 852 or similar. Run "help mode" for more information on how to change
