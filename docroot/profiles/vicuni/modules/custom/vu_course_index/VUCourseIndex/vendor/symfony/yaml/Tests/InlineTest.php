...
class InlineTest extends \PHPUnit_Framework_TestCase {
  ...
  public function getTestsForParse() {
    return array(
      ...
      array(
        '[foo, bar: { foo: bar }]',
        array('foo', '1' => array('bar' => array('foo' => 'bar')))
      ),
      array(
  ...
  public function getTestsForParseWithMapObjects() {
    return array(
      ...
      array(
        '{ foo: {bar: foo} }',
        (object) array('foo' => (object) array('bar' => 'foo'))
      ),
      array(
        '{ foo: [bar, foo] }',
        (object) array('foo' => array('bar', 'foo'))
      ),
      ...
      array(
        '[{ foo: {bar: foo} }]',
        array((object) array('foo' => (object) array('bar' => 'foo')))
      ),
      ...
      array(
        ...
        array(
          ...
          (object) array(
            'bar' => 'foo',
            'foo' => array('foo', (object) array('bar' => 'foo'))
          ),
      ...
      array(
        ...
        array(
          'foo',
          '1' => (object) array('bar' => (object) array('foo' => 'bar'))
        )
      ),
      array(
        '[foo, \'@foo.baz\', { \'%foo%\': \'foo is %foo%\', bar: \'%foo%\' }, true, \'@service_container\']',
      ...
      array(
        '{ foo  : bar, bar : {}  }',
        (object) array('foo' => 'bar', 'bar' => new \stdClass())
      ),
      array(
        '{ foo  : [], bar : {}  }',
        (object) array('foo' => array(), 'bar' => new \stdClass())
      ),
      array(
        '{foo: \'bar\', bar: {} }',
        (object) array('foo' => 'bar', 'bar' => new \stdClass())
      ...
      array(
        '[foo, [{}, {}]]',
        array('foo', array(new \stdClass(), new \stdClass()))
      ),
      ...
      array(
        '[foo, {bar: {}}]',
        array('foo', '1' => (object) array('bar' => new \stdClass()))
      ),
    );
  }
