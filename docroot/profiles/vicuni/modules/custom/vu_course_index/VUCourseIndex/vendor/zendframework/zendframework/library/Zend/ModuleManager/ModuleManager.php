...
class ModuleManager implements ModuleManagerInterface {
  ...
  public function loadModules() {
    ...
    $this->getEventManager()
      ->trigger(ModuleEvent::EVENT_LOAD_MODULES, $this, $this->getEvent());
     ...
     */
    $this->getEventManager()
      ->trigger(ModuleEvent::EVENT_LOAD_MODULES_POST, $this, $this->getEvent());
  ...
  public function loadModule($module) {
    ...
    $this->getEventManager()
      ->trigger(ModuleEvent::EVENT_LOAD_MODULE, $this, $event);
  ...
  protected function loadModuleByName($event) {
    $result = $this->getEventManager()
      ->trigger(ModuleEvent::EVENT_LOAD_MODULE_RESOLVE, $this, $event, function ($r) {
        return (is_object($r));
      });
  ...
  /**
   * Set an array or Traversable of module names that this module manager
   * should load.
   *
  ...
  protected function attachDefaultListeners() {
    ...
    $events->attach(ModuleEvent::EVENT_LOAD_MODULES, array(
      $this,
      'onLoadModules'
    ));
  }
