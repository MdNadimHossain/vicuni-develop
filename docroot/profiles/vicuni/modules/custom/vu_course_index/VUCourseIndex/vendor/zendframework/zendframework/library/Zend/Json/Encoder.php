...
class Encoder {
   ...
   * Constructor
   *
   * @param  bool $cycleCheck Whether or not to check for recursion when
   *   encoding
   ...
   * @param  bool $cycleCheck Whether or not to check for possible object
   ...
   *    - basic datums (e.g. numbers or strings) (returns from {@link
   * _encodeDatum()})
   *
  ...
  protected function _encodeString(&$string) {
    ...
    // 0x08 => \b
    // 0x0c => \f
    $string = str_replace(array(chr(0x08), chr(0x0C)), array(
      '\b',
      '\f'
    ), $string);
