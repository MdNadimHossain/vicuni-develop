...
class SessionManager extends AbstractManager {
   ...
   * - send_expire_cookie: whether or not to send a cookie expiring the current
   * session cookie
   * - clear_storage: whether or not to empty the storage object of any stored
   * values
   *
   * @var array
   */
  ...
  /**
   * @var EventManagerInterface Validation chain to determine if session is
   *   valid
   */
   ...
   *
   * @param bool $preserveStorage If set to true, current session storage will
   *   not be overwritten by the contents of $_SESSION.
   *
   * @return void
   * @throws Exception\RuntimeException
   */
