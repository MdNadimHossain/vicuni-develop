...
class Navigation extends AbstractNavigationHelper {
   ...
   *
   * @throws \Zend\View\Exception\ExceptionInterface        if proxying to a
   *   helper, and the helper is not an instance of the interface specified in
   *                                    {@link findHelper()}
   * @throws \Zend\Navigation\Exception\ExceptionInterface  if method does not
   *   exist in container
   ...
   *
   * @throws Exception\RuntimeException if $strict is true and helper cannot be
   *   found
