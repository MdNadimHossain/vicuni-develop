...
class MergeProxiesTest extends OrmFunctionalTestCase {
   ...
   * @group #1172
   *
   * Bug discovered while working on DDC-2704 - merging towards un-initialized
   *   proxies does not initialize them, causing merged data to be lost when
   *   they are actually initialized
   */
