...
DOCBLOCK;
   ...
   * @expectedExceptionMessage Attribute "value" of
   *   @Doctrine\Tests\Common\Annotations\Fixtures\AnnotationEnum declared on
   *   property SomeClassName::invalidProperty. accept only [ONE, TWO, THREE],
   *   but got FOUR.
   */
   ...
   * @expectedException \Doctrine\Common\Annotations\AnnotationException
   * @expectedExceptionMessage Attribute "value" of
   *   @Doctrine\Tests\Common\Annotations\Fixtures\AnnotationEnumLiteral declared
   *   on property SomeClassName::invalidProperty. accept only
  ...
  /**
   * @expectedException \InvalidArgumentException
   * @expectedExceptionMessage Undefined enumerator value "3" for literal
   *   "AnnotationEnumLiteral::THREE".
   */
  ...
  /**
   * @expectedException \Doctrine\Common\Annotations\AnnotationException
   * @expectedExceptionMessage The annotation
   *   @SomeAnnotationClassNameWithoutConstructorAndProperties declared on 
...
DOCBLOCK;
  ...
  /**
   * @expectedException \InvalidArgumentException
   * @expectedExceptionMessage Invalid Target "Foo". Available targets: [ALL,
...
DOCBLOCK;
  ...
  /**
   * @expectedException \InvalidArgumentException
   * @expectedExceptionMessage @Target expects either a string value, or an
   *   array of strings, "NULL" given.
   */
...
DOCBLOCK;
   ...
   * @group DDC-78
   * @expectedException \Doctrine\Common\Annotations\AnnotationException
   * @expectedExceptionMessage Expected PlainValue, got ''' at position 10 in
...
DOCBLOCK;
  ...
  /**
   * @expectedException \Doctrine\Common\Annotations\AnnotationException
   * @expectedExceptionMessage [Creation Error] The annotation
   *   @SomeAnnotationClassNameWithoutConstructor declared on some class does
   *   not have a property named "invalidaProperty". Available properties:
   *   data, name
   */
...
DOCBLOCK;
  ...
  /**
   * @expectedException \Doctrine\Common\Annotations\AnnotationException
   * @expectedExceptionMessage [Syntax Error] Expected
   *   Doctrine\Common\Annotations\DocLexer::T_IDENTIFIER or
  ...
  public function testSupportsEscapedQuotedValues() {
    $result = $this->createTestParser()
      ->parse('@Doctrine\Tests\Common\Annotations\Name(foo="""bar""")');
