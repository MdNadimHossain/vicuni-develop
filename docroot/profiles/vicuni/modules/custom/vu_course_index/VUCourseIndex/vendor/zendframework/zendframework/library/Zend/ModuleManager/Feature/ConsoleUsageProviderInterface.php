...
interface ConsoleUsageProviderInterface {
   ...
   * Zend\Console\Adapter\AdapterInterface that can be used to directly access
   * Console and send output.
   *
   * If the result is a string it will be shown directly in the console window.
   * If the result is an array, its contents will be formatted to console
   * window width. The array must have the following format:
   *
   *     return array(
