...
class ConsoleAdapterFactory implements FactoryInterface {
   ...
   * In case we're not in a Console environment, return a dummy stdClass
   * object.
   *
   * In order to disable adapter auto-detection and use a specific adapter (and
   * charset), add the following fields to application configuration, for
   * example:
   *
   *     'console' => array(
   *         'adapter' => 'MyConsoleAdapter',     // always use this console
   * adapter
   *         'charset' => 'MyConsoleCharset',     // always use this console
   * charset
   *      ),
