...
class CallbackCheckAdapter extends AbstractAdapter {
  /**
   * $credentialValidationCallback - This overrides the Treatment usage to
   * provide a callback that allows for validation to happen in code
   *
   * @var callable
   */
  ...
  /**
   * setCredentialValidationCallback() - allows the developer to use a callback
   * as a way of checking the credential.
   *
