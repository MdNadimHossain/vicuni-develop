...
class ClassGenerator extends AbstractGenerator {
  ...
  public static function fromReflection(ClassReflection $classReflection) {
    ...
    foreach ($classReflection->getProperties() as $reflectionProperty) {
      if ($reflectionProperty->getDeclaringClass()
   ...
   * @configkey filegenerator  FileGenerator File generator that holds this
   *   class
   * @configkey namespacename  string        The namespace for this class
   * @configkey docblock       string        The docblock information
   * @configkey flags          int           Flags, one of
   *   ClassGenerator::FLAG_ABSTRACT ClassGenerator::FLAG_FINAL
   * @configkey extendedclass  string        Class which this class is
   *   extending
