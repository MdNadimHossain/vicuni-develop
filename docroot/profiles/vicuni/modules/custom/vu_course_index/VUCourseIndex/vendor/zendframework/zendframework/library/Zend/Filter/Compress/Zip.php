...
class Zip extends AbstractCompressionAlgorithm {
   ...
   * @throws Exception\RuntimeException if unable to open zip archive, or error
   *   during compression
   */
   ...
   *
   * @return string
   * @throws Exception\RuntimeException If archive file not found, target
   *   directory not found, or error during decompression
   */
