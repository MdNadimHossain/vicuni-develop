...
class FirePhp extends AbstractWriter {
   ...
   *
   * @param null|FirePhp\FirePhpInterface|array|Traversable $instance An
   *   instance of FirePhpInterface that should be used for logging
   */
   ...
   *
   * @param  FirePhp\FirePhpInterface $instance A FirePhpInterface instance to
   *   set.
   *
   * @return FirePhp
   */
