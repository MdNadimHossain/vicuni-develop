...
class Token {
  ...
  /**
   * @OneToMany(targetEntity="Login", cascade={"persist", "remove"},
   *   mappedBy="token")
   * @var array
   */
  public $logins;
  ...
  /**
   * @ManyToOne(targetEntity="Action", cascade={"persist", "remove"},
   *   inversedBy="tokens")
  ...
  /**
   * @ManyToOne(targetEntity="ComplexAction", cascade={"persist", "remove"},
   *   inversedBy="tokens")
   * @JoinColumns({
