...
abstract class Barcode {
   ...
   *
   * @param  mixed $barcode String name of barcode class, or Traversable
   *   object.
   * @param  mixed $renderer String name of renderer class
   * @param  mixed $barcodeConfig OPTIONAL; an array or Traversable object with
   *   barcode parameters.
   * @param  mixed $rendererConfig OPTIONAL; an array or Traversable object
   *   with renderer parameters.
   * @param  bool $automaticRenderError OPTIONAL; set the automatic rendering
   *   of exception
   *
   * @return Barcode
   ...
   *
   * @param mixed $renderer String name of renderer class, or Traversable
   *   object.
   * @param mixed $rendererConfig OPTIONAL; an array or Traversable object with
   *   renderer parameters.
   *
  ...
  public static function render(
    ...
    static::factory($barcode, $renderer, $barcodeConfig, $rendererConfig)
      ->render();
  }
  ...
  public static function draw(
    ...
    return static::factory($barcode, $renderer, $barcodeConfig, $rendererConfig)
      ->draw();
  }
