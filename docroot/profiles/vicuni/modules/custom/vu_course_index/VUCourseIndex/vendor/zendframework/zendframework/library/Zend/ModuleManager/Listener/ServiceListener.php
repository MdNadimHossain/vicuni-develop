...
class ServiceListener implements ServiceListenerInterface {
  ...
  /**
   * Default service manager used to fulfill other SMs that need to be lazy
   * loaded
   *
   * @var ServiceManager
   */
  ...
  /**
   * @param  ServiceManager|string $serviceManager Service Manager instance or
   *   name
  ...
  public function attach(EventManagerInterface $events) {
    $this->listeners[] = $events->attach(ModuleEvent::EVENT_LOAD_MODULE, array(
      $this,
      'onLoadModule'
    ));
   ...
   *
   * @param  ServiceConfig|string $config Instance of ServiceConfig or class
   *   name
   *
   * @throws Exception\RuntimeException
   * @return array
