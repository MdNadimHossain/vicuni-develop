...
abstract class Console {
   ...
   *
   * @param  null|string $forceAdapter Optional adapter class name. Can be
   *   absolute namespace or class name relative to Zend\Console\Adapter\. If
   *   not provided, a best matching adapter will be automatically selected.
   * @param  null|string $forceCharset optional charset name can be absolute
   *   namespace or class name relative to Zend\Console\Charset\. If not
   *   provided, charset will be detected automatically.
   *
