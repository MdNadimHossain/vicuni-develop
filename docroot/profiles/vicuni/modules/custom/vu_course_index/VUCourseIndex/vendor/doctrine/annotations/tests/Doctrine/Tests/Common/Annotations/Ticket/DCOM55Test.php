...
class DCOM55Test extends \PHPUnit_Framework_TestCase {
   ...
   * @expectedExceptionMessage [Semantical Error] The class
   *   "Doctrine\Tests\Common\Annotations\Fixtures\Controller" is not annotated
   *   with @Annotation. Are you sure this class can be used as annotation? If
   *   so, then you need to add @Annotation to the _class_ doc comment of
   *   "Doctrine\Tests\Common\Annotations\Fixtures\Controller". If it is indeed
   *   no annotation, then you need to add @IgnoreAnnotation("Controller") to
   *   the _class_ doc comment of class
   *   Doctrine\Tests\Common\Annotations\Ticket\Dummy.
   */
