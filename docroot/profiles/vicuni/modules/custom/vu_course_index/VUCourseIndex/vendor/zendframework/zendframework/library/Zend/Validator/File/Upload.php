...
class Upload extends AbstractValidator {
   ...
   *
   * The array $files must be given in syntax of Zend\File\Transfer\Transfer to
   * be checked If no files are given the $_FILES array will be used
   * automatically. NOTE: This validator will only work with HTTP POST uploads!
   *
   * @param  array|\Traversable $options Array of files in syntax of
   ...
   *
   * @param  array $files The files to check in syntax of
   *   \Zend\File\Transfer\Transfer
   *
   ...
   *
   * @param  string $value Single file to check for upload errors, when giving
   *   null the $_FILES array from initialization will be used
   * @param  mixed $file
   *
   * @return bool
   */
