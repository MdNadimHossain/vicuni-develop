...
/**
 * Controller Plugin to assist in selecting an appropriate View Model type
 * based on the User Agent's accept header.
 */
class AcceptableViewModelSelector extends AbstractPlugin {
  /**
   *
   * @var string the Key to inject the name of a viewmodel with in an Accept
   *   Header
   */
   ...
   * @param bool $returnDefault (optional) If no match is available. Return
   *   default instead
   * @param AbstractFieldValuePart|null $resultReference (optional) The object
   *   that was matched
   *
   * @throws InvalidArgumentException If the supplied and matched View Model
   *   could not be found
   ...
   *   that was matched.
   *
   * @return ModelInterface|null Returns null if $returnDefault = false and no
   *   match could be made
   */
  ...
  /**
   * Set the default Accept Types and View Model combinations to match against
  ...
  /**
   * Get the default Accept Types and View Model combinations to match against
   * if none are specified.
   *
   * @return array|null
   */
