...
class FilesystemOptions extends AdapterOptions {
   ...
   *
   * @param false|string|int $dirPermission FALSE to disable explicit
   *   permission or an octal number
   *
   * @return FilesystemOptions
   * @see setUmask
   ...
   *
   * @param false|string|int $filePermission FALSE to disable explicit
   *   permission or an octal number
   *
   * @return FilesystemOptions
   * @see setUmask
   ...
   *
   * Note: On multithreaded webservers it's better to explicit set file and dir
   * permission.
   *
