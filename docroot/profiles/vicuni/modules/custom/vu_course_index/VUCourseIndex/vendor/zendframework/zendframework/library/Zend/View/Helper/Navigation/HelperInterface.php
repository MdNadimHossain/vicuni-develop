...
interface HelperInterface extends BaseHelperInterface {
   ...
   * Renders helper
   *
   * @param  string|Navigation\AbstractContainer $container [optional]
   *   container to render. Default is null, which indicates that the helper
   *   should render the container returned by {@link getContainer()}.
   *
   ...
   *
   * @param  string|Navigation\AbstractContainer $container [optional]
   *   container to operate on. Default is null, which indicates that the
   ...
   *
   * @param  bool $useAcl [optional] whether ACL should be used. Default is
   *   true.
   *
   * @return HelperInterface
   */
