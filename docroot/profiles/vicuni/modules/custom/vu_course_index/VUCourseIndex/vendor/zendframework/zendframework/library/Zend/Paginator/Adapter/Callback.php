...
class Callback implements AdapterInterface {
   ...
   * Constructs instance.
   *
   * @param CallbackHandler|callable $itemsCallback Callback to be executed to
   *   retrieve the items for a page.
   * @param CallbackHandler|callable $countCallback Callback to be executed to
