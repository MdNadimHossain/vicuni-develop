 ...
 *   array())
 * @method HeadScript offsetSetFile($index, $src, $type = 'text/javascript',
 *   $attrs = array())
 ...
 *   array())
 * @method HeadScript offsetSetScript($index, $src, $type = 'text/javascript',
 *   $attrs = array())
...
class HeadScript extends Placeholder\Container\AbstractStandalone {
   ...
   *
   * @throws Exception\BadMethodCallException if too few arguments or invalid
   *   method
   * @return HeadScript
   */
   ...
   *
   * @param  string|int $indent Amount of whitespaces or string to use for
   *   indention
   *
   * @return string
   */
