...
abstract class AbstractHydrator implements
  ...
  /**
   * Converts a value for extraction. If no strategy exists the plain value is
   * returned.
   *
  ...
  /**
   * Converts a value for hydration. If no strategy exists the plain value is
   * returned.
   *
   * @param string $name The name of the strategy to use.
   * @param mixed $value The value that should be converted.
  ...
  /**
   * Convert a name for extraction. If no naming strategy exists, the plain
   * value is returned.
   *
  ...
  /**
   * Converts a value for hydration. If no naming strategy exists, the plain
   * value is returned.
   *
   * @param string $name The name to convert.
   * @param array $data The whole data is optionally provided as context.
