...
abstract class AbstractHelper extends Helper\AbstractHelper {
   ...
   *
   * @param  mixed $value
   * @param  int $recurse Expects one of the recursion constants; used to
   *   decide whether or not to recurse the given value when escaping
   *
   * @throws Exception\InvalidArgumentException
   * @return mixed Given a scalar, a scalar value is returned. Given an object,
   *   with the $recurse flag not allowing object recursion, returns a string.
