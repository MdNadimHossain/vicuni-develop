...
class DeclareVars extends AbstractHelper {
  ...
  /**
   * Declare template vars to set default values and avoid notices when using
   * strictVars
   *
   ...
   * </code>
   *
   * @param string|array variable number of arguments, all string names of
   *   variables to test
   *
   * @return void
   */
   ...
   * Set a view variable
   *
   * Checks to see if a $key is set in the view object; if not, sets it to
   * $value.
   *
   * @param  string $key
