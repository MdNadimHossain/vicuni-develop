...
class BaseInputFilter implements
  ...
  /**
   * Provide a list of one or more elements indicating the complete set to
   * validate
   *
   * When provided, calls to {@link isValid()} will only validate the provided
   * set.
   *
   * If the initial value is {@link VALIDATE_ALL}, the current validation
   * group, if any, should be cleared.
   *
   * Implementations should allow passing a single array value, or multiple
