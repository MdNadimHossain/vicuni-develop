 ...
 * @DiscriminatorMap({4 = "DDC2138UserFollowedUser", 3 =
...
class DDC2138User {
   ...
   * @OneToMany(targetEntity="DDC2138UserFollowedUser", mappedBy="user",
   ...
   * @OneToMany(targetEntity="DDC2138UserFollowedStructure", mappedBy="user",
   *   cascade={"persist"}, orphanRemoval=true)
   */
