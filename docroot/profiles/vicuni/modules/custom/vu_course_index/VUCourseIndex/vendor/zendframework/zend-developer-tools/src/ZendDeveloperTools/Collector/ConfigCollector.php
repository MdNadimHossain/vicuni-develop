...
/**
 * Config data collector - dumps the contents of the `Config` and
...
class ConfigCollector implements CollectorInterface, Serializable {
  ...
  /**
   * Opposite of {@see makeArraySerializable} - replaces stubs in an array with
   * actual un-serializable objects
   *
   * @param array $data
   *
   * @return array
