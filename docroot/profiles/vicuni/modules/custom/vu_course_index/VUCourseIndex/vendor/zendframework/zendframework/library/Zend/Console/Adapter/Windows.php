...
class Windows extends Virtual {
   ...
   *
   * Run a Windows Powershell command that determines parameters of console
   * window. The command is fed through standard input (with echo) to prevent
   * Powershell from creating a sub-thread and hanging PHP when run through a
   * debugger/IDE.
   *
   * @return void
   */
