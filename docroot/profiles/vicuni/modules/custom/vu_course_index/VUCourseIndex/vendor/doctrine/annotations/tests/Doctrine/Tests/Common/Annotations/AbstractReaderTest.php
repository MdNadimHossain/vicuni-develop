...
abstract class AbstractReaderTest extends \PHPUnit_Framework_TestCase {
   ...
   * @expectedExceptionMessage [Semantical Error] Annotation
   *   @AnnotationTargetPropertyMethod is not allowed to be declared on class
   *   Doctrine\Tests\Common\Annotations\Fixtures\ClassWithInvalidAnnotationTargetAtClass.
   *   You may only use this annotation on these code elements: METHOD,
   *   PROPERTY
   */
   ...
   * @expectedException \Doctrine\Common\Annotations\AnnotationException
   * @expectedExceptionMessage [Semantical Error] Annotation
   *   @AnnotationTargetClass is not allowed to be declared on property
   ...
   * @expectedException \Doctrine\Common\Annotations\AnnotationException
   * @expectedExceptionMessage [Semantical Error] Annotation
   *   @AnnotationTargetAnnotation is not allowed to be declared on property
   ...
   * @expectedException \Doctrine\Common\Annotations\AnnotationException
   * @expectedExceptionMessage [Semantical Error] Annotation
   *   @AnnotationTargetClass is not allowed to be declared on method
  ...
  /**
   * @expectedException \Doctrine\Common\Annotations\AnnotationException
   * @expectedExceptionMessage Expected namespace separator or identifier, got
   *   ')' at position 24 in class
  ...
  /**
   * @expectedException \Doctrine\Common\Annotations\AnnotationException
   * @expectedExceptionMessage [Type Error] Attribute "string" of
   *   @AnnotationWithVarType declared on property
  ...
  /**
   * @expectedException \Doctrine\Common\Annotations\AnnotationException
   * @expectedExceptionMessage [Type Error] Attribute "annotation" of
   *   @AnnotationWithVarType declared on method
   *   Doctrine\Tests\Common\Annotations\Fixtures\ClassWithAnnotationWithVarType::invalidMethod()
   *   expects a(n)
   *   Doctrine\Tests\Common\Annotations\Fixtures\AnnotationTargetAll, but got
   *   an instance of
   ...
   *   Doctrine\Tests\Common\Annotations\TestAnnotationNotImportedClass::$field
   *   was never imported.
   */
   ...
   *   Doctrine\Tests\Common\Annotations\TestNonExistentAnnotationClass::$field
   *   was never imported.
   */
  ...
  /**
   * When getUseStatements isn't available on ReflectionClass the PhpParser has
   * to use token_get_all(). If that happens various PHP compiler globals get
   * set, and these can have seriously bad effects on the next file to be
   * parsed. Notably the doc_comment compiler global can end up containing a
   * docblock comment. The next file to be parsed on an include() will have
   * this docblock comment attached to the first thing in the file that the
   * compiler considers to own comments. If this is a class then any later
   * calls to getDocComment() for that class will have undesirable effects.
   * *sigh*
   */
  ...
  /**
   * @expectedException \Doctrine\Common\Annotations\AnnotationException
   * @expectedExceptionMessage The class
   *   "Doctrine\Tests\Common\Annotations\Fixtures\NoAnnotation" is not
   *   annotated with @Annotation. Are you sure this class can be used as
   *   annotation? If so, then you need to add @Annotation to the _class_ doc
   *   comment of "Doctrine\Tests\Common\Annotations\Fixtures\NoAnnotation". If
   *   it is indeed no annotation, then you need to add
   *   @IgnoreAnnotation("NoAnnotation") to the _class_ doc comment of class
