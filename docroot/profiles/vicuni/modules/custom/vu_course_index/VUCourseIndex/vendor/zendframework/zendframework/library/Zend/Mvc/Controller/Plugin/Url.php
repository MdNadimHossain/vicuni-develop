...
class Url extends AbstractPlugin {
   ...
   * @param  array|Traversable $params Parameters to use in url generation, if
   *   any
   * @param  array|bool $options RouteInterface-specific options to use in url
   *   generation, if any. If boolean, and no fourth argument, used as
   *   $reuseMatchedParams.
