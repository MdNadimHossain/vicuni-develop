...
class Base64 extends AbstractScalar {
   ...
   *
   * @param string $value
   * @param bool $alreadyEncoded If set, it means that the given string is
  ...
  /**
   * Return the value of this object, convert the XML-RPC native base64 value
   * into a PHP string We return this value decoded (a normal string)
   *
   * @return string
   */
