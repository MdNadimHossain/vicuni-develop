...
abstract class AbstractContainer extends ArrayObject {
  ...
  /**
   * Default manager to use when instantiating a container without providing a
   * ManagerInterface
   *
   * @var Manager
   */
   ...
   * Constructor
   *
   * Provide a name ('Default' if none provided) and a ManagerInterface
   * instance.
   *
  ...
  /**
   * Set the default ManagerInterface instance to use when none provided to
   * constructor
   *
   * @param  Manager $manager
   *
   ...
   *
   * @return Manager
   * @throws Exception\InvalidArgumentException if invalid manager default
   *   class provided
   */
   ...
   * object.
   *
   * @param  bool $createContainer Whether or not to create the container for
   *   the namespace
   *
   * @return Storage|null               Returns null only if $createContainer
   *   is false
