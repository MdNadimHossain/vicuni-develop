...
class Translator implements TranslatorInterface {
  ...
  /**
   * Event fired when no messages were loaded for a locale/text-domain
   * combination.
   */
   ...
   *
   * @return bool
   * @throws Exception\RuntimeException When specified loader is not a remote
   *   loader
   */
   ...
   *
   * @return bool
   * @throws Exception\RuntimeException When specified loader is not a file
   *   loader
   */
