...
class File extends Part\File implements MessageInterface {
   ...
   * Public constructor
   *
   * In addition to the parameters of Zend\Mail\Storage\Part::__construct()
   * this constructor supports:
   * - flags array with flags for message, keys are ignored, use constants
   * defined in Zend\Mail\Storage
   *
   * @param  array $params
   *
