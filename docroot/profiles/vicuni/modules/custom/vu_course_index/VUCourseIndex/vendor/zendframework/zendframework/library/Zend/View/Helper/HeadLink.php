 ...
 * @method HeadLink appendStylesheet($href, $media = 'screen',
 *   $conditionalStylesheet = '', $extras = array())
 * @method HeadLink offsetSetStylesheet($index, $href, $media = 'screen',
 *   $conditionalStylesheet = '', $extras = array())
 * @method HeadLink prependStylesheet($href, $media = 'screen',
 *   $conditionalStylesheet = '', $extras = array())
 * @method HeadLink setStylesheet($href, $media = 'screen',
 *   $conditionalStylesheet = '', $extras = array())
