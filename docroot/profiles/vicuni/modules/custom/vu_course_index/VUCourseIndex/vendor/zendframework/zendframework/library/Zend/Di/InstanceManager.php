...
/**
 * Registry of instantiated objects, their names and the parameters used to
 * build them
 */
class InstanceManager /* implements InstanceManagerInterface */
{
   ...
   * @var array
   */
  protected $sharedInstancesWithParams = array(
    'hashShort' => array(),
    'hashLong' => array()
  );
  ...
  /**
   * Retrieves an instance by its name and the parameters stored at its
   * instantiation
   *
   * @param  string $classOrAlias
   * @param  array $params
  ...
  /**
   * Adds a type preference. A type preference is a redirection to a preferred
   * alias or type when an abstract type
