...
class TreeRouteStack extends SimpleRouteStack {
   ...
   * @throws Exception\InvalidArgumentException When route definition is not an
   *   array nor traversable
   * @throws Exception\InvalidArgumentException When chain routes are not an
   *   array nor traversable
   * @throws Exception\RuntimeException         When a generated routes does
   *   not implement the HTTP route interface
   */
