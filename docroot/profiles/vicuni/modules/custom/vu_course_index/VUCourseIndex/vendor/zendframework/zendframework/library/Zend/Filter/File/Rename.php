...
class Rename extends Filter\AbstractFilter {
   ...
   * an array. If an array or Zend\Config\Config object, it accepts the
   * following keys:
   * 'source'    => Source filename or directory which will be renamed
   * 'target'    => Target filename or directory, the new name of the source
   * file
   * 'overwrite' => Shall existing files be overwritten ?
   * 'randomize' => Shall target files have a random postfix attached?
   *
   * @param  string|array|Traversable $options Target file or directory to be
   *   renamed
   *
   ...
   * @throws Exception\InvalidArgumentException If the target file already
   *   exists.
   */
