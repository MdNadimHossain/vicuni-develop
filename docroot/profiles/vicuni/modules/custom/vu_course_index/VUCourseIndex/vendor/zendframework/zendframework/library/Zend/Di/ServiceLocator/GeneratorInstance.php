...
class GeneratorInstance {
  ...
  /**
   * Class of the instance. Null if class is unclear (such as when the instance
   * is produced by a callback)
   *
   * @return string|null
   */
   ...
   * Each parameter that refers to another instance fetched recursively is a
   * GeneratorInstance itself
   *
   * @return array
   */
   ...
   * order. Each returned element has form array('method' => 'methodName',
   * 'params' => array( ... ordered list of call parameters ... ), where every
   * call parameter that is a recursively fetched instance is a
   * GeneratorInstance itself
   *
   * @return array
   */
