 ...
 *
 * A Runner takes one or more Checks and runs them in sequence. One or more
 * Reporters can be attached to display the progress and results of checks.
 */
class Runner {
  /**
  ...
  /**
   * Create new instance of Runner, optionally providing configuration and
   * initial collection of Checks.
   *
   ...
   *
   * @param  string|null $checkAlias An alias of Check instance to run, or null
   *   to run all checks.
   *
