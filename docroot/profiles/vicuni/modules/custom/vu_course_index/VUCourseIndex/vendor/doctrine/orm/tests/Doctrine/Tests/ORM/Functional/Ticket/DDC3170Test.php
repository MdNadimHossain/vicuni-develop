...
class DDC3170Test extends \Doctrine\Tests\OrmFunctionalTestCase {
  ...
  /**
   * Tests that the discriminator column is correctly read from the meta
   * mappings when fetching a child from an inheritance mapped class.
   *
   * The simple object hydration maps the type field to a field alias like
   * type2. This mapping needs to be considered when loading the discriminator
   * column's value from the SQL result.
   *
   * {@see
