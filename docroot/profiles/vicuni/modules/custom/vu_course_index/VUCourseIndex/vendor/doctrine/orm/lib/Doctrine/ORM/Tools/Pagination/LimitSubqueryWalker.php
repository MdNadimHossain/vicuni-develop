...
/**
 * Replaces the selectClause of the AST with a SELECT DISTINCT root.id
 * equivalent.
 *
 * @category    DoctrineExtensions
 * @package     DoctrineExtensions\Paginate
...
class LimitSubqueryWalker extends TreeWalkerAdapter {
  ...
  /**
   * Walks down a SelectStatement AST node, modifying it to retrieve DISTINCT
   * ids of the root Entity.
   *
  ...
  /**
   * Validate the AST to ensure that this walker is able to properly manipulate
   * it.
   *
   * @param SelectStatement $AST
   */
  ...
  /**
   * Retrieve either an IdentityFunction (IDENTITY(u.assoc)) or a state field
   * (u.name).
   *
