...
/**
 * Class for Zend\View\Strategy\PhpRendererStrategy to help enforce private
 * constructs.
 *
 ...
 *   \Zend\View\Helper\HeadScript::FILE, $spec = NULL, $placement = 'APPEND',
 ...
 * @method \Zend\View\Helper\HeadTitle headTitle($title = NULL, $setType =
 *   NULL)
 ...
 * @method string paginationControl(\Zend\Paginator\Paginator $paginator =
 *   NULL, $scrollingStyle = NULL, $partial = NULL, $params = NULL)
 ...
 * @method string url($name = NULL, array $params = array(), $options =
...
class PhpRenderer implements Renderer, TreeRendererInterface {
   ...
   * @param  null|array $options Options to pass to plugin constructor (if not
   ...
   * PhpRenderer. It is then up to the developer to render the children from
