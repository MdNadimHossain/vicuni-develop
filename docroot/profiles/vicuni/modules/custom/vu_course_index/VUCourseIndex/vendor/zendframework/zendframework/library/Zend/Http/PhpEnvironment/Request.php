...
class Request extends HttpRequest {
  ...
  /**
   * Return the parameter container responsible for server parameters or a
  ...
  /**
   * Return the parameter container responsible for env parameters or a single
   * parameter value.
   *
   * @param string|null $name Parameter name to retrieve, or null to get the
   *   whole container.
   * @param mixed|null $default Default value to use when the parameter is
   *   missing.     * @return \Zend\Stdlib\ParametersInterface
   *
   * @return \Zend\Stdlib\ParametersInterface|mixed
   */
