...
class CredentialTreatmentAdapter extends AbstractAdapter {
  /**
   * $credentialTreatment - Treatment applied to the credential, such as MD5()
   * or PASSWORD()
   *
   * @var string
   */
  ...
  /**
   * setCredentialTreatment() - allows the developer to pass a parametrized
   * string that is used to transform or treat the input credential data.
   *
   ...
   * algorithm. By specifying a parametrized treatment string with this method,
   * a developer may apply arbitrary SQL upon input credential data.
   *
   * Examples:
   *
   *  'PASSWORD(?)'
