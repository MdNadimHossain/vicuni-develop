...
abstract class AbstractProtocol {
   ...
   * Constructor.
   *
   * @param  string $host OPTIONAL Hostname of remote connection (default:
   *   127.0.0.1)
   ...
   *
   * An example $remote string may be 'tcp://mail.example.com:25' or
   ...
   * Throws a Zend\Mail\Protocol\Exception\ExceptionInterface if an unexpected
   * code is returned.
   *
   * @param  string|array $code One or more codes that indicate a successful
   *   response
   * @param  int $timeout Per-request timeout value if applicable
   *
   * @throws Exception\RuntimeException
