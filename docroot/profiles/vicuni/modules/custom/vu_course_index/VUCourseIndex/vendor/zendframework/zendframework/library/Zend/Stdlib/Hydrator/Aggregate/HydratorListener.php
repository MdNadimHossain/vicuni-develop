...
class HydratorListener extends AbstractListenerAggregate {
  ...
  public function attach(EventManagerInterface $events, $priority = 1) {
    $this->listeners[] = $events->attach(HydrateEvent::EVENT_HYDRATE, array(
      $this,
      'onHydrate'
    ), $priority);
    $this->listeners[] = $events->attach(ExtractEvent::EVENT_EXTRACT, array(
      $this,
      'onExtract'
    ), $priority);
  }
  ...
  /**
   * Callback to be used when {@see
   * \Zend\Stdlib\Hydrator\Aggregate\HydrateEvent::EVENT_HYDRATE} is triggered
   *
  ...
  /**
   * Callback to be used when {@see
   * \Zend\Stdlib\Hydrator\Aggregate\ExtractEvent::EVENT_EXTRACT} is triggered
   *
