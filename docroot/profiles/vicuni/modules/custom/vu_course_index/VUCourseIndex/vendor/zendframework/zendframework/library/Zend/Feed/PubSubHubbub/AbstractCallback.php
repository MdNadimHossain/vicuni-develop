...
abstract class AbstractCallback implements CallbackInterface {
  /**
   * An instance of
   * Zend\Feed\Pubsubhubbub\Model\SubscriptionPersistenceInterface used to
   * background save any verification tokens associated with a subscription or
   * other.
   *
   ...
   * Zend\Feed\Pubsubhubbub\HttpResponse which shares an unenforced interface
   * with
   ...
   * used to background save any verification tokens associated with a
  ...
  /**
   * Gets an instance of Zend\Feed\Pubsubhubbub\Model\SubscriptionPersistence
   * used to background save any verification tokens associated with a
   * subscription or other.
   *
