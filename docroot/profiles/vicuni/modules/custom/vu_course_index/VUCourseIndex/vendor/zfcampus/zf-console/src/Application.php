...
class Application {
   ...
   * @param array|Traversable $routes Routes/route specifications to use for
   *   the application
   * @param Console $console Console adapter to use within the application
   * @param Dispatcher $dispatcher Configured dispatcher mapping routes to
   *   callables
   */
   ...
   * Set routes to use
   *
   * Allows specifying an array of routes, which may be mixed Route instances
   * or array specifications for creating routes.
   *
