...
class SecondLevelCacheOneToOneTest extends SecondLevelCacheAbstractTest {
  public function testPutOneToOneOnUnidirectionalPersist() {
    ...
    $this->assertTrue($this->cache->containsEntity(TravelerProfile::CLASSNAME, $entity1->getProfile()
      ->getId()));
    $this->assertTrue($this->cache->containsEntity(TravelerProfile::CLASSNAME, $entity2->getProfile()
      ->getId()));
  }
  ...
  public function testPutOneToOneOnBidirectionalPersist() {
    ...
    $this->assertTrue($this->cache->containsEntity(TravelerProfile::CLASSNAME, $entity2->getProfile()
      ->getId()));
    $this->assertTrue($this->cache->containsEntity(TravelerProfileInfo::CLASSNAME, $entity1->getProfile()
      ->getInfo()
      ->getId()));
    $this->assertTrue($this->cache->containsEntity(TravelerProfileInfo::CLASSNAME, $entity2->getProfile()
      ->getInfo()
      ->getId()));
  }
  ...
  public function testPutAndLoadOneToOneUnidirectionalRelation() {
    ...
    $this->assertFalse($this->cache->containsEntity(TravelerProfile::CLASSNAME, $entity1->getProfile()
      ->getId()));
    $this->assertFalse($this->cache->containsEntity(TravelerProfile::CLASSNAME, $entity2->getProfile()
      ->getId()));
    ...
    $this->assertEquals($entity1->getProfile()->getId(), $t1->getProfile()
      ->getId());
    $this->assertEquals($entity1->getProfile()->getName(), $t1->getProfile()
      ->getName());

    $this->assertEquals($entity2->getId(), $t2->getId());
    $this->assertEquals($entity2->getName(), $t2->getName());
    $this->assertEquals($entity2->getProfile()->getId(), $t2->getProfile()
      ->getId());
    $this->assertEquals($entity2->getProfile()->getName(), $t2->getProfile()
      ->getName());
    ...
    $this->assertEquals($entity1->getProfile()->getId(), $t3->getProfile()
      ->getId());
    $this->assertEquals($entity2->getProfile()->getId(), $t4->getProfile()
      ->getId());

    $this->assertEquals($entity1->getProfile()->getName(), $t3->getProfile()
      ->getName());
    $this->assertEquals($entity2->getProfile()->getName(), $t4->getProfile()
      ->getName());
  ...
  public function testPutAndLoadOneToOneBidirectionalRelation() {
    ...
    $this->assertFalse($this->cache->containsEntity(TravelerProfileInfo::CLASSNAME, $entity1->getInfo()
      ->getId()));
    $this->assertFalse($this->cache->containsEntity(TravelerProfileInfo::CLASSNAME, $entity2->getInfo()
      ->getId()));
    ...
    $this->assertEquals($entity1->getInfo()->getDescription(), $p1->getInfo()
      ->getDescription());
    ...
    $this->assertEquals($entity2->getInfo()->getDescription(), $p2->getInfo()
      ->getDescription());
    ...
    $this->assertTrue($this->cache->containsEntity(TravelerProfileInfo::CLASSNAME, $entity1->getInfo()
      ->getId()));
    $this->assertTrue($this->cache->containsEntity(TravelerProfileInfo::CLASSNAME, $entity2->getInfo()
      ->getId()));
    ...
    $this->assertEquals($entity1->getInfo()->getDescription(), $p3->getInfo()
      ->getDescription());
    ...
    $this->assertEquals($entity2->getInfo()->getDescription(), $p4->getInfo()
      ->getDescription());
