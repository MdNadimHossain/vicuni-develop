...
class Dn implements ArrayAccess {
   ...
   * Control characters with an ASCII code < 32 are represented as \hexpair.
   ...
   *
   * @param  string|array $values An array containing the DN values that should
   *   be escaped
   *
   ...
   * @param  string $caseFold
   *
   * @return bool True if the DN was successfully parsed or false if the string
   *   is not a valid DN.
   */
