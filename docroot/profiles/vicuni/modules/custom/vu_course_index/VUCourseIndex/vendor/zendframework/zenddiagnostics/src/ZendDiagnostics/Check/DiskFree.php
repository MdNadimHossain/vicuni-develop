...
class DiskFree extends AbstractCheck implements CheckInterface {
   ...
   * @var  array
   */
  public static $siPrefixName = array(
    '',
    'kilo',
    'mega',
    'giga',
   ...
   * @var  array
   */
  public static $iecPrefixSymbol = array(
    '',
    'Ki',
    'Mi',
    'Gi',
   ...
   * @var  array
   */
  public static $iecPrefixName = array(
    '',
    'kibi',
    'mebi',
    'gibi',
  ...
  /**
   * @param  int|string $size Minimum disk size in bytes or a valid byte string
   *   (IEC, SI or Jedec).
   * @param  string $path The disk path to check, i.e. '/tmp' or 'C:' (defaults
   *   to /)
   *
  ...
  /**
   * Converts int bytes to a highest, rounded, multiplication that is IEC
   * compliant.
   *
