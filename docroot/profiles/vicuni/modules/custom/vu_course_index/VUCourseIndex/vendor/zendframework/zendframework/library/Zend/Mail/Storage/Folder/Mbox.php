...
class Mbox extends Storage\Mbox implements FolderInterface {
   ...
   *
   * Result is save in \Zend\Mail\Storage\Folder instances with the root in
   * $this->rootFolder.
   * $parentFolder and $parentGlobalName are only used internally for
   * recursion.
   *
  ...
  /**
   * magic method for unserialize(), with this method you can cache the mbox
   * class
   */
