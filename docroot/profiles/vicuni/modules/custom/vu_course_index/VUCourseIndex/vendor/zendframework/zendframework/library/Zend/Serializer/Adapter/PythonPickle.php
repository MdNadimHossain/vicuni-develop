...
class PythonPickle extends AbstractAdapter {
   ...
   * The listing here is in kind-of alphabetical order of 1-character pickle
   *   code. pickletools groups them by purpose.
   */
   ...
   * Load a proto value
   *
   * @throws Exception\RuntimeException if Pickle version does not support this
   *   feature
   */
