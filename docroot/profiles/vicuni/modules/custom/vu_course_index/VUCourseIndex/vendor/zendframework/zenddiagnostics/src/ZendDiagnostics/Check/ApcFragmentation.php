 ...
 *      authors:   Ralf Becker <beckerr@php.net>, Rasmus Lerdorf
 * <rasmus@php.net>, Ilia Alshanetsky <ilia@prohost.org> license:   The PHP
 * License, version 3.01 copyright: Copyright (c) 2006-2011 The PHP Group
 */
