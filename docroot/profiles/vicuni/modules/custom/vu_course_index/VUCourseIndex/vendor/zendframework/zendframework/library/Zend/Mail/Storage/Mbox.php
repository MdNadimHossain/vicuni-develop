...
class Mbox extends AbstractStorage {
  ...
  /**
   * start and end position of messages as array('start' => start, 'separator'
   * => headersep, 'end' => end)
   *
   * @var array
   */
   ...
   *
   * Mbox does not support unique ids (yet) - it's always the same as the
   * message number. That shouldn't be a problem, because we can't change mbox
   * files. Therefor the message number is save enough.
   *
