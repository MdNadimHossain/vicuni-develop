...
class Reflection {
   ...
   *
   * Creates a {@link \Zend\Server\Reflection\ClassReflection} object for the
   * class or object provided.
   *
   * If extra arguments should be passed to dispatchable methods, these may
   * be provided as an array to $argv.
   *
   * @param string|object $class Class name or object
   * @param  bool|array $argv Optional arguments to be used during the method
   *   call
