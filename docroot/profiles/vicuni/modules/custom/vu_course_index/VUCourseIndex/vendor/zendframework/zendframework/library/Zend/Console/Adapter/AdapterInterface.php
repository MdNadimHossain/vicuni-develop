...
interface AdapterInterface {
   ...
   * If X or Y coordinate value is negative, it will be calculated as the
   * distance from far right or bottom edge of the console (respectively).
   *
   ...
   * @param int $fillStyle (optional) Box fill style or a single character to
   *   fill it with.
  ...
  /**
   * Write a block of text at the given coordinates, matching the supplied
   * width and height. In case a line of text does not fit desired width, it
   * will be wrapped to the next line. In case the whole text does not fit in
   * desired height, it will be truncated.
   *
   * @param string $text Text to write
   * @param int $width Maximum block width. Negative value means distance from
   *   right edge.
   * @param int|null $height Maximum block height. Negative value means
