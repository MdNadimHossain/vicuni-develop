...
class ConnectionTest extends \Doctrine\Tests\DbalTestCase {
  ...
  public function testEventManagerPassedToPlatform() {
    ...
    $this->assertInstanceOf('Doctrine\Common\EventManager', $connection->getDatabasePlatform()
      ->getEventManager());
    $this->assertSame($connection->getEventManager(), $connection->getDatabasePlatform()
      ->getEventManager());
  }
...
SQLSTATE[HY000]: General error: 1 near \"MUUHAAAAHAAAA\"");
  ...
  /**
   * Pretty dumb test, however we want to check that the EchoSQLLogger
  ...
  public function testEchoSQLLogger() {
    ...
    $this->assertSame($logger, $this->_conn->getConfiguration()
      ->getSQLLogger());
  }

  /**
   * Pretty dumb test, however we want to check that the DebugStack correctly
  ...
  public function testEmptyInsert() {
    ...
    $conn = $this->getMockBuilder('Doctrine\DBAL\Connection')
      ...
      ->setConstructorArgs(array(
        array('platform' => new Mocks\MockPlatform()),
        $driverMock
      ))
      ->getMock();
