...
class DDC758Test extends \Doctrine\Tests\OrmFunctionalTestCase {
  ...
  /**
   * Test that changing associations on detached entities and then cascade
   * merging them causes the database to be updated with the new associations.
  ...
  public function testManyToManyMergeAssociationAdds() {
    ...
    $cmsUsers = $this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsUser')
      ->findAll();
    $cmsGroups = $this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')
      ->findAll();
