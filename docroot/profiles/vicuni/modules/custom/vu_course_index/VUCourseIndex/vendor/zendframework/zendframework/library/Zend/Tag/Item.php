...
class Item implements TaggableInterface {
   ...
   *
   * @throws \Zend\Tag\Exception\InvalidArgumentException When invalid options
   *   are provided
   * @throws \Zend\Tag\Exception\InvalidArgumentException When title was not
   *   set
   * @throws \Zend\Tag\Exception\InvalidArgumentException When weight was not
   *   set
   */
   ...
   * @param  string $title
   *
   * @throws \Zend\Tag\Exception\InvalidArgumentException When title is no
   *   string
   * @return \Zend\Tag\Item
   */
   ...
   * @param  float $weight
   *
   * @throws \Zend\Tag\Exception\InvalidArgumentException When weight is not
   *   numeric
   * @return \Zend\Tag\Item
   */
