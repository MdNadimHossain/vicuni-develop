...
/**
 * @todo       allow specifying status code as a default, or as an option to
 *   methods
 */
class Redirect extends AbstractPlugin {
   ...
   * @param  array $options RouteInterface-specific options to use in url
   *   generation, if any
   * @param  bool $reuseMatchedParams Whether to reuse matched parameters
   *
   * @return Response
   * @throws Exception\DomainException if composed controller does not
   *   implement InjectApplicationEventInterface, or router cannot be found in
   *   controller event
   */
