...
class SqlitePlatformTest extends AbstractPlatformTestCase {
  ...
  public function testGenerateTableSqlShouldNotAutoQuotePrimaryKey() {
    ...
    $table->addColumn('"like"', 'integer', array(
      'notnull' => TRUE,
      'autoincrement' => TRUE
    ));
  ...
  public function testAlterTableAddColumns() {
    ...
    $diff->addedColumns['count'] = new Column('count', Type::getType('integer'), array(
      'notnull' => FALSE,
      'default' => 1
    ));
  ...
  public function testCreateTableWithDeferredForeignKeys() {
    ...
    $table->addForeignKeyConstraint('user', array('parent'), array('id'), array(
      'deferrable' => TRUE,
      'deferred' => TRUE
    ));
