 ...
 * called by the Zend\XmlRpc\Client object and as the return value for those
 * calls.
 *
 * This object as a very important static function
 * Zend\XmlRpc\Value::getXmlRpcValue, this function acts likes a factory for
 * the Zend\XmlRpc\Value objects
 *
 * Using this function, users/Zend\XmlRpc\Client object can create the
 * Zend\XmlRpc\Value objects from PHP variables, XML string or by specifying
 * the exact XML-RPC native type
 */
abstract class AbstractValue {
  ...
  /**
   * Specify that the XML-RPC native type will be auto detected from a PHP
   * variable type
   */
  ...
  /**
   * Get the native XML-RPC type (the type is one of the Value::XMLRPC_TYPE_*
   * constants)
   *
   * @return string
   */
  ...
  /**
   * Return the value of this object, convert the XML-RPC native value into a
   * PHP variable
   *
   * @return mixed
   */
   ...
   * 2. By specifying the native type ($type is one of the Value::XMLRPC_TYPE_*
   * constants)
   ...
   *
   * @param string|\SimpleXMLElement $xml A SimpleXMLElement object represent
   *   the XML string It can be also a valid XML string for conversion
   *
   * @throws Exception\ValueException
