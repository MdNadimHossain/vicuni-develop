...
abstract class AbstractAdapter extends BaseAdapter {
  ...
  /**
   * setCredentialColumn() - set the column name to be used as the credential
   * column
   *
  ...
  /**
   * getDbSelect() - Return the preauthentication Db Select object for userland
   ...
   *
   * @throws Exception\RuntimeException if answering the authentication query
   *   is impossible
  ...
  /**
   * _authenticateCreateSelect() - This method creates a Zend\Db\Sql\Select
   * object that is completely configured to be queried against the database.
   *
   * @return Sql\Select
   */
   ...
   *
   * @throws Exception\RuntimeException in the event that setup was not done
   *   properly
   * @return bool
   */
  ...
  /**
   * _authenticateQuerySelect() - This method accepts a Zend\Db\Sql\Select
   * object and performs a query against the database with that object.
   *
   * @param  Sql\Select $dbSelect
   *
   * @throws Exception\RuntimeException when an invalid select object is
   *   encountered
   * @return array
   */
