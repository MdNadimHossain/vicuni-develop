...
class ProcessHelper extends Helper {
   ...
   * @param string|array|Process $cmd An instance of Process or an array of
   *   arguments to escape and run or a command to run
   * @param string|null $error An error message that must be displayed if
   *   something went wrong
   * @param callable|null $callback A PHP callback to run whenever there is
   *   some
   *                                        output available on STDOUT or
   *   STDERR
   ...
   * Runs the process.
   *
   * This is identical to run() except that an exception is thrown if the
