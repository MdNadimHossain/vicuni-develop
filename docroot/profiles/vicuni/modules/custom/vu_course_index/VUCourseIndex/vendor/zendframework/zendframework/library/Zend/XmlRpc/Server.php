...
class Server extends AbstractServer {
   ...
   *
   * @return Server
   * @throws Server\Exception\InvalidArgumentException on invalid request class
   *   or object
   */
   ...
   *
   * Returns an array of dispatchables
   * (Zend\Server\Reflection\ReflectionFunction, ReflectionMethod, and
   * ReflectionClass items).
   *
   * @return array
   */
   ...
   * will receive the arguments. If set to false, only constructor will receive
   * the arguments
   */
