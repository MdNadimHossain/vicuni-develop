...
class GenerateRepositoriesCommandTest extends OrmFunctionalTestCase {
  ...
  public function testGenerateRepositories() {
    ...
    $this->assertSame('Doctrine\ORM\EntityRepository', $repo1->getParentClass()
      ->getName());
    $this->assertSame('Doctrine\ORM\EntityRepository', $repo2->getParentClass()
      ->getName());
  }
  ...
  public function testGenerateRepositoriesCustomDefaultRepository() {
    ...
    $this->assertSame('Doctrine\Tests\Models\DDC3231\DDC3231EntityRepository', $repo1->getParentClass()
      ->getName());
    $this->assertSame('Doctrine\Tests\Models\DDC3231\DDC3231EntityRepository', $repo2->getParentClass()
      ->getName());
  }
  ...
  private function generateRepositories($filter, $defaultRepository = NULL) {
    if ($defaultRepository) {
      $this->_em->getConfiguration()
        ->setDefaultRepositoryClassName($defaultRepository);
    }
