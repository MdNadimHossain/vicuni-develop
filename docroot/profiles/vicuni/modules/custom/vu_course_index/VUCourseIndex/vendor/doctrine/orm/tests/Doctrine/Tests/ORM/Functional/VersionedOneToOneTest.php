...
/**
 * Tests that an entity with a OneToOne relationship defined as the id, with a
 * version field can be created.
 *
...
class VersionedOneToOneTest extends \Doctrine\Tests\OrmFunctionalTestCase {
  ...
  /**
   * This test case tests that a versionable entity, that has a oneToOne
   * relationship as it's id can be created without this bug fix (DDC-3318),
