...
class Folder implements RecursiveIterator {
   ...
   * @param bool $selectable if true folder holds messages, if false it's just
   *   a parent for subfolders (Default: true)
   * @param array $folders init with given instances of
   *   \Zend\Mail\Storage\Folder as subfolders
   */
