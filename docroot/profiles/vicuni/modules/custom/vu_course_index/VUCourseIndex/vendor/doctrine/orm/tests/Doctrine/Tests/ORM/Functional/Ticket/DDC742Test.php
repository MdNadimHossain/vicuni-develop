...
class DDC742Test extends \Doctrine\Tests\OrmFunctionalTestCase {
  ...
  protected function setUp() {
    ...
    $this->_em->getMetadataFactory()
      ->setCacheDriver(new FilesystemCache($testDir));
    ...
    $this->_em->getMetadataFactory()
      ->setMetadataFor(__NAMESPACE__ . '\DDC742User', NULL);
    $this->_em->getMetadataFactory()
      ->setMetadataFor(__NAMESPACE__ . '\DDC742Comment', NULL);
  }
...
class DDC742User {
  ...
  public $title;
  /**
   * @ManyToMany(targetEntity="DDC742Comment", cascade={"persist"},
   *   fetch="EAGER")
   * @JoinTable(
   *  name="user_comments",
