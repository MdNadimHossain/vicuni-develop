...
class FilterComposite implements FilterInterface {
   ...
   *
   * This example will exclude all methods from the hydration, that starts with
   * 'getService'
   * <code>
   ...
   * @param  int $condition Can be either FilterComposite::CONDITION_OR or
   *   FilterComposite::CONDITION_AND
   *
   * @throws InvalidArgumentException
   ...
   *
   * @param $property string Parameter will be e.g.
   *   Parent\Namespace\Class::method
   *
   * @return bool
   */
