...
class OutputCache extends AbstractPattern {
  ...
  /**
   * if there is a cached item with the given key display it's data and return
   * true else start buffering output until end() is called or the script ends.
   *
  ...
  /**
   * Stops buffering output, write buffered data to cache using the given key
   * on start() and displays the buffer.
   *
   * @throws Exception\RuntimeException if output cache not started or
   *   buffering not active
