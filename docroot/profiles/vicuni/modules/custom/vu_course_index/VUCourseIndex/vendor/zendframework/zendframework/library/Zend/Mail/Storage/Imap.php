...
class Imap extends AbstractStorage implements Folder\FolderInterface, Writable\WritableInterface {
   ...
   *   - user username
   *   - host hostname or ip address of IMAP server [optional, default =
   * 'localhost']
   ...
   * use unique ids as parameter and use this method to translate it to message
   * number right before calling removeMessage()
   *
   ...
   *
   * @param  \Zend\Mail\Storage\Folder|string $globalName global name of folder
   *   or instance for subfolder
   *
   * @throws Exception\RuntimeException
   * @throws \Zend\Mail\Protocol\Exception\RuntimeException
   */
   ...
   *
   * @param  string $name global name of folder, local name if $parentFolder is
   *   set
   ...
   *
   * NOTE: IMAP has no native move command, thus it's emulated with copy and
   * delete
   *
   * @param  int $id number of message
   * @param  string|\Zend\Mail\Storage\Folder $folder name or instance of
