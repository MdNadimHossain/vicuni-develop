...
class Table {
   ...
   * @throws Exception\InvalidArgumentException When a column has an invalid
   *   width
   * @return Table
   */
   ...
   *
   * @throws Exception\InvalidArgumentException When $row is neither an array
   *   nor Zend\Text\Table\Row
   ...
   * Render the table
   *
   * @throws Exception\UnexpectedValueException When no rows were added to the
   *   table
   * @return string
   */
