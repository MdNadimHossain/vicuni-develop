...
class Mail extends AbstractWriter {
   ...
   * level appended to the end.  Since a Zend\Mail\Message subject can only be
   * set once, this method cannot be used if the Zend\Mail\Message object
   * already has a subject set.
   *
