 ...
 * @method HeadMeta offsetGetName($index, $keyValue, $content, $modifiers =
 *   array())
 ...
 * @method HeadMeta offsetGetHttpEquiv($index, $keyValue, $content, $modifiers
 *   = array())
 ...
 * @method HeadMeta offsetGetProperty($index, $keyValue, $content, $modifiers =
 *   array())
...
class HeadMeta extends Placeholder\Container\AbstractStandalone {
  ...
  protected function isValid($item) {
    ...
    if (!isset($item->content)
      && (!$this->view->plugin('doctype')->isHtml5()
        || (!$this->view->plugin('doctype')
            ->isHtml5() && $item->type !== 'charset'))
    ) {
      return FALSE;
    }
  ...
  /**
   * Create an HTML5-style meta charset tag. Something like <meta
   * charset="utf-8">
   *
