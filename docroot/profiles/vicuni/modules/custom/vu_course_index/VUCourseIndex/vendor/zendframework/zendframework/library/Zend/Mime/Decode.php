...
class Decode {
   ...
   * @param  string $boundary boundary as found in content-type
   * @param  string $EOL EOL string; defaults to {@link
   *   Zend\Mime\Mime::LINEEND}
   *
   * @return array|null parts as array('header' => array(name => value), 'body'
   *   => content), null if no parts found
   * @throws Exception\RuntimeException
   */
   ...
   *
   * @param  string|Headers $message raw message with header and optional
   *   content
   ...
   * @param  string $wantedPart the wanted part, else an array with all parts
   *   is returned
   *
   * @return string|array wanted part or all parts as array('type' =>
   *   content-type, partname => value)
   */
