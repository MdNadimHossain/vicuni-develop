...
abstract class AbstractDb extends AbstractValidator {
   ...
   * Exclude can either be a String containing a where clause, or an array with
   * `field` and `value` keys to define the where clause added to the sql. A
   * database adapter may optionally be supplied to avoid using the registered
   * default adapter.
   *
   ...
   * 'exclude' => An optional where clause or field/value pair to exclude from
   * the query
   ...
   *
   * @throws \Zend\Validator\Exception\RuntimeException When no database
   *   adapter is defined
   * @return DbAdapter
   */
