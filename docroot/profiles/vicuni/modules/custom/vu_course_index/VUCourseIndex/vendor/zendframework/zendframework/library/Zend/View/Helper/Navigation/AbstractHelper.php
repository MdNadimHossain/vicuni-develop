...
abstract class AbstractHelper extends View\Helper\AbstractHtmlElement implements
  ...
  /**
   * Verifies container and eventually fetches it from service locator if it is
   * a string
   *
   ...
   *
   * @param  string|Navigation\AbstractContainer $container Default is null,
   *   meaning container will be reset.
   *
   * @return AbstractHelper
   */
   ...
   *                     instance of type {@link Acl\Role\RoleInterface}, or
   *   null. Default is null, which will set no role.
   *
   * @return AbstractHelper
   * @throws Exception\InvalidArgumentException
   */
   ...
   *                     instance of {@link Acl\Role\RoleInterface}. Default is
