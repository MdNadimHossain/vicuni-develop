...
class DefaultCacheFactoryTest extends OrmTestCase {
   ...
   * @expectedExceptionMessage If you what to use a "READ_WRITE" cache an
   *   implementation of "Doctrine\ORM\Cache\ConcurrentRegion" is required, The
   *   default implementation provided by doctrine is
   *   "Doctrine\ORM\Cache\Region\FileLockRegion" if you what to use it please
