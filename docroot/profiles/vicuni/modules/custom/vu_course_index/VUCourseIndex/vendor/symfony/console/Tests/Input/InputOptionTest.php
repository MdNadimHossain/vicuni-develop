...
class InputOptionTest extends \PHPUnit_Framework_TestCase {
   ...
   * @expectedExceptionMessage Impossible to have an option mode VALUE_IS_ARRAY
   ...
   * @expectedExceptionMessage Cannot set a default value when using
  ...
  /**
   * @expectedException        \LogicException
   * @expectedExceptionMessage A default value for an array option must be an
   *   array.
   */
