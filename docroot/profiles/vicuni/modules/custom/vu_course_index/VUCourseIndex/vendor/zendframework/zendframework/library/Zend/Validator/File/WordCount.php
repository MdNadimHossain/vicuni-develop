...
class WordCount extends AbstractValidator {
  ...
  protected $options = array(
    'min' => NULL,
    // Minimum word count, if null there is no minimum word count
    'max' => NULL,
    // Maximum word count, if null there is no maximum word count
  );

  /**
   * Sets validator options
   *
   * Min limits the word count, when used with max=null it is the maximum word
