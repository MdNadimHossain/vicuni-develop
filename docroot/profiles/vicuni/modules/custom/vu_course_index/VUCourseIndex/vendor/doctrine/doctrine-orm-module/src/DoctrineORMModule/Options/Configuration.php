...
class Configuration extends DBALConfiguration {
   ...
   * the keys 'sql' for native SQL query string and 'rsm' for the
  ...
  /**
   * Repository factory or name of the repository factory service to be set in
   * ORM configuration (if any)
   *
   ...
   *
   * @return self
   * @throws InvalidArgumentException   when the provided naming strategy does
   *   not fit the expected type
   */
   ...
   *
   * @return self
   * @throws InvalidArgumentException   when the provided repository factory
