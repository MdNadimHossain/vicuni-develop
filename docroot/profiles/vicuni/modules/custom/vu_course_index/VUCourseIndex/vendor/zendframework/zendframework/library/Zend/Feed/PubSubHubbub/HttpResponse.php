...
class HttpResponse {
   ...
   * Send all headers
   *
   * Sends any headers specified. If an {@link setHttpResponseCode() HTTP
   * response code} has been specified, it is sent with the first header.
   *
   * @return void
   */
   ...
   * Can we send headers?
   *
   * @param  bool $throw Whether or not to throw an exception if headers have
