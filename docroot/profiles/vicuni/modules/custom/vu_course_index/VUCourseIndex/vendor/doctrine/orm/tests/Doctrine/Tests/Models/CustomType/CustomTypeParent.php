...
class CustomTypeParent {
  ...
  /**
   * @OneToOne(targetEntity="Doctrine\Tests\Models\CustomType\CustomTypeChild", cascade={"persist",
   *   "remove"})
   */
  public $child;
   ...
   *     joinColumns={@JoinColumn(name="customtypeparent_id",
   *   referencedColumnName="id")},
   *   inverseJoinColumns={@JoinColumn(name="friend_customtypeparent_id",
   *   referencedColumnName="id")}
   * )
   */
  private $myFriends;
