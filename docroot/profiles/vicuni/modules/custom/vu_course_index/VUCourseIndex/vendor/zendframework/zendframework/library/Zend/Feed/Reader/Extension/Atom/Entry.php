...
class Entry extends Extension\AbstractEntry {
  ...
  public function getDateCreated() {
    ...
    if ($this->getAtomType() === Reader\Reader::TYPE_ATOM_03) {
      $dateCreated = $this->getXpath()
        ->evaluate('string(' . $this->getXpathPrefix() . '/atom:created)');
    }
    else {
      $dateCreated = $this->getXpath()
        ->evaluate('string(' . $this->getXpathPrefix() . '/atom:published)');
    }
  ...
  public function getDateModified() {
    ...
    if ($this->getAtomType() === Reader\Reader::TYPE_ATOM_03) {
      $dateModified = $this->getXpath()
        ->evaluate('string(' . $this->getXpathPrefix() . '/atom:modified)');
    }
    else {
      $dateModified = $this->getXpath()
        ->evaluate('string(' . $this->getXpathPrefix() . '/atom:updated)');
    }
  ...
  public function getDescription() {
    ...
    $description = $this->getXpath()
      ->evaluate('string(' . $this->getXpathPrefix() . '/atom:summary)');
  ...
  public function getEnclosure() {
    ...
    $nodeList = $this->getXpath()
      ->query($this->getXpathPrefix() . '/atom:link[@rel="enclosure"]');
  ...
  public function getId() {
    ...
    $id = $this->getXpath()
      ->evaluate('string(' . $this->getXpathPrefix() . '/atom:id)');
  ...
  public function getTitle() {
    ...
    $title = $this->getXpath()
      ->evaluate('string(' . $this->getXpathPrefix() . '/atom:title)');
  ...
  public function getCategories() {
    ...
    if ($this->getAtomType() == Reader\Reader::TYPE_ATOM_10) {
      $list = $this->getXpath()
        ->query($this->getXpathPrefix() . '//atom:category');
    }
    else {
      /**
      ...
      $list = $this->getXpath()
        ->query($this->getXpathPrefix() . '//atom10:category');
    }
  ...
  public function getSource() {
    ...
    if ($this->getType() == Reader\Reader::TYPE_ATOM_10) {
      $list = $this->getXpath()
        ->query($this->getXpathPrefix() . '/atom:source[1]');
      if ($list->length) {
        $element = $list->item(0);
