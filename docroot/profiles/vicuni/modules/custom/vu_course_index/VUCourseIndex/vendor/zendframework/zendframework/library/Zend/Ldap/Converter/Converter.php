...
/**
 * Zend\Ldap\Converter is a collection of useful LDAP related conversion
 * functions.
 */
class Converter {
  const STANDARD = 0;
   ...
   * @link   http://pear.php.net/package/Net_LDAP2
   * @author Benedikt Hallinger <beni@php.net>, heavily based on work from
   *   DavidSmith@byu.net
   *
   * @param string $string String to convert
   *
   ...
   * @param  bool $asUtc Whether to return the LDAP-compatible date-string as
   *   UTC or as local value
   *
   * @return string
   ...
   *
   * @return DateTime
   * @throws Exception\InvalidArgumentException if a non-parseable-format is
   *   given
   */
