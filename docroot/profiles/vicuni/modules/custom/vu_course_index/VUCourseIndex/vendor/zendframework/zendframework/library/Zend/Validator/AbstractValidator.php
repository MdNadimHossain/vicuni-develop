...
abstract class AbstractValidator implements
  ...
  protected $abstractOptions = array(
    ...
    'valueObscured' => FALSE,
    // Flag indicating whether or not value should be obfuscated
    // in error messages
  );
   ...
   *  - an array f.e. Validator(array($first => 'first', $second => 'second',
   * $third => 'third'))
   ...
   *
   * @throws Exception\InvalidArgumentException If $options is not an array or
   *   Traversable
  ...
  /**
   * Returns an array of the names of variables that are used in constructing
  ...
  /**
   * Sets validation failure message templates given as an array, where the
   * array keys are the message keys, and the array values are the message
   * template strings.
   *
  ...
  /**
   * Magic function returns the value of the requested property, if and only if
   * it is the value or a message variable.
   *
  ...
  /**
   * Constructs and returns a validation failure message with the given message
   * key and value.
   *
   * Returns null if and only if $messageKey does not correspond to an existing
   * template.
   *
