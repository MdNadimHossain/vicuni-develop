...
abstract class ArrayUtils {
   ...
   *
   * @param  array|Traversable $iterator The array or Traversable object to
   *   convert
   * @param  bool $recursive Recursively check all nested structures
   *
   * @throws Exception\InvalidArgumentException if $iterator is not an array or
   ...
   * the value from the second array will be appended to the first array. If
   * both values are arrays, they are merged together, else the value of the
   * second array overwrites the one of the first array.
   *
   * @param  array $a
   * @param  array $b
