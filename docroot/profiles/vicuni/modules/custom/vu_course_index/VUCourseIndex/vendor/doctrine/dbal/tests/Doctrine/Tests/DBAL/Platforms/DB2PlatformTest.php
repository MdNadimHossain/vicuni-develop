...
class DB2PlatformTest extends AbstractPlatformTestCase {
  ...
  public function testReturnsBinaryTypeDeclarationSQL() {
    ...
    $this->assertSame('BINARY(32704)', $this->_platform->getBinaryTypeDeclarationSQL(array(
      'fixed' => TRUE,
      'length' => 32704
    )));
    $this->assertSame('BLOB(1M)', $this->_platform->getBinaryTypeDeclarationSQL(array(
      'fixed' => TRUE,
      'length' => 32705
    )));
  }
  ...
  public function getGeneratesAlterColumnSQL() {
    return array(
      ...
      array(
        'precision',
        new Column('bar', Type::getType('decimal'), array(
          'precision' => 10,
          'scale' => 2
        )),
      ...
      array(
        'fixed',
        new Column('bar', Type::getType('string'), array(
          'length' => 20,
          'fixed' => TRUE
        )),
      ...
      array(
        'default',
        new Column('bar', Type::getType('integer'), array(
          'autoincrement' => TRUE,
          'default' => 666
        )),
        NULL
