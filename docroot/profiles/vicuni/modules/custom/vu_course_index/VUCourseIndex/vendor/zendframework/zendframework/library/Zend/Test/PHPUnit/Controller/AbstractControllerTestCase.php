...
abstract class AbstractControllerTestCase extends PHPUnit_Framework_TestCase {
  ...
  public function getApplication() {
    ...
    $events->detach($this->application->getServiceManager()
  ...
  public function assertModulesLoaded(array $modules) {
    $moduleManager = $this->getApplicationServiceLocator()
      ->get('ModuleManager');
  ...
  protected function getControllerFullClassName() {
    ...
    $controllerManager = $this->getApplicationServiceLocator()
  ...
  /**
   * Recursively search a view model and it's children for the given
   * templateName
   *
