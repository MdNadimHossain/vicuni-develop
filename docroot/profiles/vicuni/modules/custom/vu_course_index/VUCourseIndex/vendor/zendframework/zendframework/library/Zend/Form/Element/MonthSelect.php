...
class MonthSelect extends Element implements InputProviderInterface, ElementPrepareAwareInterface {
  ...
  /**
   * If set to true, it will generate an empty option for every select (this is
   * mainly needed by most JavaScript libraries to allow to have a placeholder)
   *
   * @var bool
   */
  ...
  /**
   * If set to true, view helpers will render delimiters between <select>
   * elements, according to the specified locale
   *
   * @var bool
   */
