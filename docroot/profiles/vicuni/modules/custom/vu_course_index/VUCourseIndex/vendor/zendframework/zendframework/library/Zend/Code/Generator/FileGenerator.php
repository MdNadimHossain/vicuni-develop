...
class FileGenerator extends AbstractGenerator {
  ...
  /**
   * Use this if you intend on generating code generation objects based on the
   * same file. This will keep previous changes to the file in tact during the
   * same PHP process
   *
   * @param  string $filePath
   * @param  bool $includeIfNotAlreadyIncluded
   *
   * @throws ReflectionException\InvalidArgumentException If file does not
   *   exists
   * @throws ReflectionException\RuntimeException If file exists but is not
  ...
  /**
   * Returns an array with the first element the use statement, second is the
   * as part. If $withResolvedAs is set to true, there will be a third element
   * that is the
   * "resolved" as statement, as the second part is not required in use
   * statements
   *
