...
interface PartInterface extends RecursiveIterator {
   ...
   * values (with Zend\Mime\Mime::LINEEND as delim).
   *
   * @param  string $name name of header, matches case-insensitive, but
   *   camel-case is replaced with dashes
   * @param  string $format change type of return value to 'string' or 'array'
   *
   * @return string|array|\Zend\Mail\Header\HeaderInterface|\ArrayIterator value
   *   of header in wanted or internal format
   * @throws Exception\ExceptionInterface
   */
