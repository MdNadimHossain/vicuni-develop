...
abstract class AbstractHttpControllerTestCase extends AbstractControllerTestCase {
  ...
  /**
   * Assert against DOM/XPath selection; should NOT contain exact number of
   * nodes
   *
   * @param  string $path CSS selector path
  ...
  /**
   * Assert against DOM/XPath selection; should contain at least this number of
   * nodes
   *
   * @param string $path CSS selector path
  ...
  /**
   * Assert against DOM/XPath selection; should contain no more than this
   * number of nodes
   *
   * @param  string $path CSS selector path
  ...
  /**
   * Assert against DOM selection; should contain no more than this number of
   * nodes
   *
   * @param  string $path CSS selector path
   * @param  string $count Maximum number of nodes that should match
  ...
  /**
   * Assert against XPath selection; should contain no more than this number of
   * nodes
   *
   * @param  string $path XPath path
   * @param  string $count Maximum number of nodes that should match
