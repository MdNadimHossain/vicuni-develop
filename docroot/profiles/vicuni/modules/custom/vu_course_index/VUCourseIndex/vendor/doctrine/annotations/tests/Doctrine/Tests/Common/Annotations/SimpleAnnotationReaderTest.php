...
class SimpleAnnotationReaderTest extends AbstractReaderTest {
  /**
   * Contrary to the behavior of the default annotation reader, we do just
   * ignore these in the simple annotation reader (so, no expected exception
   * here).
   */
   ...
   * @group regression
   *
   * Contrary to the behavior of the default annotation reader, @version is not
   *   ignored
   */
