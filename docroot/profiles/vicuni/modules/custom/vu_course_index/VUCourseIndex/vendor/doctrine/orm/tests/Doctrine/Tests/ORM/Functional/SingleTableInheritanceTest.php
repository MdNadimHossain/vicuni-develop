...
class SingleTableInheritanceTest extends \Doctrine\Tests\OrmFunctionalTestCase {
  ...
  public function testPersistChildOfBaseClass() {
    ...
    $this->assertEquals($this->salesPerson->getId(), $contract->getSalesPerson()
      ->getId());
  }
  ...
  public function testFindAllForAbstractBaseClass() {
    $this->loadFullFixture();
    $contracts = $this->_em->getRepository('Doctrine\Tests\Models\Company\CompanyContract')
      ->findAll();
  ...
  public function testFindAllForChildClass() {
    ...
    $this->assertEquals(1, count($this->_em->getRepository('Doctrine\Tests\Models\Company\CompanyFixContract')
      ->findAll()));
  ...
  public function testQueryForAbstractBaseClass() {
    ...
    $contracts = $this->_em->createQuery('SELECT c FROM Doctrine\Tests\Models\Company\CompanyContract c')
      ->getResult();
  ...
  public function testQueryForChildClass() {
    ...
    $this->assertEquals(1, count($this->_em->createQuery('SELECT c FROM Doctrine\Tests\Models\Company\CompanyFixContract c')
      ->getResult()));
    $this->assertEquals(2, count($this->_em->createQuery('SELECT c FROM Doctrine\Tests\Models\Company\CompanyFlexContract c')
      ->getResult()));
    $this->assertEquals(1, count($this->_em->createQuery('SELECT c FROM Doctrine\Tests\Models\Company\CompanyFlexUltraContract c')
      ->getResult()));
  }
  ...
  public function testQueryBaseClassWithJoin() {
    ...
    $contracts = $this->_em->createQuery('SELECT c, p FROM Doctrine\Tests\Models\Company\CompanyContract c JOIN c.salesPerson p')
      ->getResult();
    $this->assertEquals(3, count($contracts));
    $this->assertContainsOnly('Doctrine\Tests\Models\Company\CompanyContract', $contracts);
  }
  ...
  public function testQueryScalarWithDiscriminatorValue() {
    ...
    $contracts = $this->_em->createQuery('SELECT c FROM Doctrine\Tests\Models\Company\CompanyContract c ORDER BY c.id')
      ->getScalarResult();
