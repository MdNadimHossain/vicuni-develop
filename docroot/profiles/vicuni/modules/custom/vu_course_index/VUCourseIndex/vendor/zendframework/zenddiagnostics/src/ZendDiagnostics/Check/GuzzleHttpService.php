...
class GuzzleHttpService extends AbstractCheck {
   ...
   * @param array $options An array of guzzle options used to create the
   *   request
   * @param int $statusCode The response status code to check
   * @param null $content The response content to check
   * @param \Guzzle\Http\Client|\GuzzleHttp\Client $guzzle Instance of guzzle
   *   to use
   * @param string $method The method of the request
   * @param mixed $body The body of the request (used for POST, PUT and DELETE
   *   requests)
   *
