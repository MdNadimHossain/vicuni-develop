    ...
    function() {
      ...
      function _(b) {
        return b.each(function(b) {
          ...
          var P = d3.select(this).classed("nv-chart-" + S, !0),
            H = this,
            B = (f || parseInt(P.style("width")) || 960) - u.left - u.right,
          ...
          var b = D(O.i, b),
            V = g ? "none" : "all",
            $ = P.selectAll("g.nv-wrap.nv-cumulativeLine").data([b]),
          ...
          $.select(".tempDisabled").remove(), G.length && $.append("text").attr("class", "tempDisabled").attr("x", B / 2).attr("y", "-.71em").style("text-anchor", "end").text(G.map(function(e) {
            ...
            left: u.left,
            top: u.top
          }).svgContainer(P).xScale(w), $.select(".nv-interactive").call(o)), J.select(".nv-background").append("rect"), K.select(".nv-background rect").attr("width", B).attr("height", j), t.y(function(e) {
            return e.display.y
          ...
          nt.enter().append("rect").attr("class", "nv-indexLine").attr("width", 3).attr("x", -2).attr("fill", "red").attr("fill-opacity", .5).style("pointer-events", "all").call(I), nt.attr("transform", function(e) {
            ...
            b.filter(function(e, t) {
              ...
              typeof s == "undefined" && (s = o), typeof l == "undefined" && (l = _.xScale()(_.x()(o, f))), c.push({
                key: n.key,
                value: _.y()(o, f),
            ...
            if (c.length > 2) {
              var h = _.yScale().invert(i.mouseY),
                p = Math.abs(_.yScale().domain()[0] - _.yScale().domain()[1]),
                d = .03 * p,
      ...
      function N(e) {
        return e.each(function(e) {
          ...
          var k = d3.select(this).selectAll("g.nv-wrap.nv-multibarHorizontal").data([e]),
            L = k.enter().append("g").attr("class", "nvd3 nv-wrap nv-multibarHorizontal"),
            A = L.append("defs"),
            O = L.append("g"),
            M = k.select("g");
      ...
      function T(e) {
        return e.each(function(h) {
          var d = d3.select(this),
            N = this,
            C = (u || parseInt(d.style("width")) || 960) - o.left - o.right,
          ...
          var O = d.selectAll("g.nv-wrap.nv-multiBarHorizontalChart").data([h]),
            M = O.enter().append("g").attr("class", "nvd3 nv-wrap nv-multiBarHorizontalChart").append("g"),
            _ = O.select("g");
      ...
      function E(e) {
        return e.each(function(e) {
          ...
          var o = n - t.left - t.right,
            ...
            S = E - E / 5,
            x = d3.select(this),
            T = x.selectAll(".nv-wrap.nv-pie").data(e),
            N = T.enter().append("g").attr("class", "nvd3 nv-wrap nv-pie nv-chart-" + u),
            C = N.append("g"),
            k = T.select("g");
      ...
      var t = {
        ...
        y = !1,
        b = .5,
        w = d3.dispatch("chartClick", "elementClick", "elementDblClick", "elementMouseover", "elementMouseout");
