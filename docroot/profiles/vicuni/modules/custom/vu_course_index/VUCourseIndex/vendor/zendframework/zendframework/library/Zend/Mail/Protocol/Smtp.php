...
class Smtp extends AbstractProtocol {
   ...
   *
   * Can be used to restore a clean smtp communication state when a transaction
   * has been cancelled or commencing a new transaction.
   *
   */
   ...
   *
   * Not used by Zend\Mail, could be used to keep a connection alive or check
   * if it is still open.
   *
   */
   ...
   *
   * This default method is implemented by AUTH adapters to properly
