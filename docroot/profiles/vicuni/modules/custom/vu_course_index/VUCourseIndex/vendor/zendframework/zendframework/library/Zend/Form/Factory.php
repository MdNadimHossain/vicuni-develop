...
class Factory {
   ...
   *
   * Ensures we have an array, Traversable, or ArrayAccess object, and returns
   * it.
   *
   * @param  array|Traversable|ArrayAccess $spec
  ...
  /**
   * Takes a list of element specifications, creates the elements, and injects
   * them into the provided fieldset
   *
  ...
  /**
   * Takes a list of fieldset specifications, creates the fieldsets, and
   * injects them into the master fieldset
   *
   ...
   *
   * Takes a string indicating a hydrator class name (or a concrete instance),
   * try first to instantiates the class by pulling it from service manager,
   * and injects the hydrator instance into the form.
   *
   ...
   *
   * @return void
   * @throws Exception\DomainException If $hydratorOrName is not a string, does
   *   not resolve to a known class, or the class does not implement
   ...
   *
   * Takes a string indicating a factory class name (or a concrete instance),
   * try first to instantiates the class by pulling it from service manager,
   * and injects the factory instance into the fieldset.
   *
   ...
   *
   * @return void
   * @throws Exception\DomainException If $factoryOrName is not a string, does
   *   not resolve to a known class, or the class does not extend Form\Factory
   */
   ...
   *
   * @return void
   * @throws Exception\DomainException for unknown InputFilter class or invalid
