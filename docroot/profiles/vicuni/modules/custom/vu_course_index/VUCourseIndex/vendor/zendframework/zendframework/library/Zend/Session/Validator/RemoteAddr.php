...
class RemoteAddr implements SessionValidator {
   ...
   * increase security. HTTP_* are not reliable since can easily be spoofed. It
   * can be enabled just for more flexibility, but if user uses proxy to
   * connect to trusted services it's his/her own risk, only reliable field for
