...
abstract class AbstractDriverTest extends DbalTestCase {
  ...
  /**
   * Factory method for creating the the platform instance return by the driver
   * under test.
   *
   * The platform instance returned by this method must be the same as returned
   * by the driver's getDatabasePlatform() method.
   *
  ...
  /**
   * Factory method for creating the the schema manager instance return by the
   * driver under test.
   *
   * The schema manager instance returned by this method must be the same as
   * returned by the driver's getSchemaManager() method.
   *
