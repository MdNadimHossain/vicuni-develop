...
/**
 * Tests a self referential many-to-many association mapping (from a model to
 * the same model, without inheritance). For simplicity the relation duplicates
 * entries in the association table to remain symmetrical.
 */
