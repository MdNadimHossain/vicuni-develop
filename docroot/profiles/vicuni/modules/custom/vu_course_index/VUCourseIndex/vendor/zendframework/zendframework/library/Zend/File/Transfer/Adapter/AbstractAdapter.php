...
abstract class AbstractAdapter implements TranslatorAwareInterface {
   ...
   *     array(form => array( - Form is the name within the form or, if not set
   * the filename name,            - Original name of this file type,          
   *  - Mime type of this file size,            - Filesize in bytes tmp_name,  
   *      - Internally temporary filename for uploaded files error,           -
   * Error which has occurred destination,     - New destination for this file
   * validators,      - Set validator names for this file files            -
   * Set file names for this file
   *     ))
   *
   * @var array
   */
   ...
   * @param  string|array $validator Validators to use for this file, must be
   *   set before
   * @param  string|array $filter Filters to use for this file, must be set
   *   before
   *
   ...
   *
   * @param  string|Validator\ValidatorInterface $validator Type of validator
   *   to add
   * @param  bool $breakChainOnFailure If the validation chain should stop a
   *   failure
   ...
   *
   * @return AbstractAdapter
   * @throws Exception\InvalidArgumentException when the given destination is
   ...
   * Uses fileinfo, when not available mime_magic and as last fallback a manual
   * given mimetype
   *
   ...
   * @param  bool $names (Optional) Returns only names on true, else complete
   *   info
   * @param  bool $noexception (Optional) Allows throwing an exception,
