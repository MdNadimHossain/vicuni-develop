...
class Operator implements PredicateInterface {
   ...
   * @param  string $leftType TYPE_IDENTIFIER or TYPE_VALUE by default
   *   TYPE_IDENTIFIER {@see allowedTypes}
   * @param  string $rightType TYPE_IDENTIFIER or TYPE_VALUE by default
   *   TYPE_VALUE {@see allowedTypes}
   */
