...
class LimitSubqueryOutputWalker extends SqlWalker {
  ...
  /**
   * @var bool We don't want to add path expressions from sub-selects into the
   *   select clause of the containing query. This state flag simply keeps
   *   track on whether we are walking on a subquery or not
   */
  ...
  /**
   * Generates a new order by clause that works in the scope of a select query
