...
class Rsa {
   ...
   *
   * $signature can be encoded in base64 or not. $mode sets how the input must
   * be processed:
   *  - MODE_AUTO: Check if the $signature is encoded in base64. Not
   ...
   *
   * $data can be encoded in base64 or not. $mode sets how the input must be
   * processed:
   *  - MODE_AUTO: Check if the $signature is encoded in base64. Not
   * recommended for performance.
