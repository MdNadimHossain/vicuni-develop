...
class Client implements ServerClient {
   ...
   *
   * @return self
   * @throws Exception\InvalidArgumentException with invalid message encoding
   *   method argument
   */
   ...
   *
   * @return self
   * @throws Exception\InvalidArgumentException with invalid local certificate
   *   path argument
   */
  ...
  public function _doRequest(Client\Common $client, $request, $location, $action, $version, $oneWay = NULL) {
    ...
    return call_user_func(array(
      $client,
      'SoapClient::__doRequest'
    ), $request, $location, $action, $version, $oneWay);
  }
  ...
  protected function _initSoapClientObject() {
    ...
    $this->soapClient = new Client\Common(array(
      $this,
      '_doRequest'
    ), $wsdl, $options);
  }
  ...
  public function call($method, $params = array()) {
    return call_user_func_array(array($this, '__call'), array(
      $method,
      $params
    ));
  }
