...
class SecondLevelCacheQueryCacheTest extends SecondLevelCacheAbstractTest {
  ...
  public function testQueryCacheModeRefresh() {
    ...
    $entry1 = new EntityCacheEntry(Country::CLASSNAME, array(
      'id' => $countryId1,
      'name' => 'outdated'
    ));
    $entry2 = new EntityCacheEntry(Country::CLASSNAME, array(
      'id' => $countryId2,
      'name' => 'outdated'
    ));
  ...
  public function testBasicQueryFetchJoinsManyToOne() {
    ...
    $this->assertTrue($this->cache->containsEntity(State::CLASSNAME, $result1[0]->getState()
      ->getId()));
    $this->assertTrue($this->cache->containsEntity(State::CLASSNAME, $result1[1]->getState()
      ->getId()));
    ...
    $this->assertEquals($result1[0]->getName(), $result2[0]->getName());
    $this->assertEquals($result1[1]->getName(), $result2[1]->getName());
    $this->assertEquals($result1[0]->getState()
      ->getName(), $result2[0]->getState()->getName());
    $this->assertEquals($result1[1]->getState()
      ->getName(), $result2[1]->getState()->getName());
  ...
  public function testBasicNativeQueryCache() {
    ...
    $result1 = $this->_em->createNativeQuery($sql, $rsm)
      ->setCacheable(TRUE)
      ->getResult();
  ...
  public function testResolveToOneAssociationCacheEntry() {
    ...
    $this->assertInstanceOf('Doctrine\Tests\Models\Cache\City', $city1->getState()
      ->getCities()
      ->get(0));
    $this->assertInstanceOf('Doctrine\Tests\Models\Cache\State', $city1->getState()
      ->getCities()
    ...
    $this->assertInstanceOf('Doctrine\Tests\Models\Cache\City', $city2->getState()
      ->getCities()
      ->get(0));
    $this->assertInstanceOf('Doctrine\Tests\Models\Cache\State', $city2->getState()
      ->getCities()
  ...
  public function testResolveToManyAssociationCacheEntry() {
    ...
    $this->assertInstanceOf('Doctrine\Tests\Models\Cache\State', $state1);
    $this->assertInstanceOf('Doctrine\ORM\Proxy\Proxy', $state1->getCountry());
    $this->assertInstanceOf('Doctrine\Tests\Models\Cache\City', $state1->getCities()
      ->get(0));
    $this->assertInstanceOf('Doctrine\Tests\Models\Cache\State', $state1->getCities()
      ->get(0)
      ->getState());
    ...
    $this->assertInstanceOf('Doctrine\Tests\Models\Cache\State', $state2);
    $this->assertInstanceOf('Doctrine\ORM\Proxy\Proxy', $state2->getCountry());
    $this->assertInstanceOf('Doctrine\Tests\Models\Cache\City', $state2->getCities()
      ->get(0));
    $this->assertInstanceOf('Doctrine\Tests\Models\Cache\State', $state2->getCities()
      ->get(0)
      ->getState());
   ...
   * @expectedExceptionMessage Second level cache does not support partial
   *   entities.
   */
  ...
  /**
   * @expectedException \Doctrine\ORM\Cache\CacheException
   * @expectedExceptionMessage Second-level cache query supports only select
   *   statements.
   */
