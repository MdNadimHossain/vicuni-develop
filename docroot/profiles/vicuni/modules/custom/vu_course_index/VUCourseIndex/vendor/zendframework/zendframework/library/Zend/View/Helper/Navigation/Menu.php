...
class Menu extends AbstractHelper {
   ...
   * @param  bool $addClassToListItem Whether or not page class applied to <li>
   *   element
   ...
   *   from. Default is to use the container retrieved from {@link
   *   getContainer()}.
   ...
   * @param  bool $addClassToListItem Whether or not to add the page class to
   *   the list item
   *
   * @return string
   */
  ...
  /**
   * Returns flag indicating whether page class should be applied to <li>
   * element
   *
