...
class SecondLevelCacheConcurrentTest extends SecondLevelCacheAbstractTest {
  ...
  protected function setUp() {
    ...
    $this->_em->getMetadataFactory()
      ->setMetadataFor(Country::CLASSNAME, $countryMetadata);
  }
  ...
  protected function tearDown() {
    ...
    $this->_em->getMetadataFactory()
      ->setMetadataFor(Country::CLASSNAME, $this->countryMetadata);
  }
  ...
  public function testBasicConcurrentCollectionReadLock() {
    ...
    $region = $this->_em->getCache()
      ->getCollectionCacheRegion(State::CLASSNAME, 'cities');
