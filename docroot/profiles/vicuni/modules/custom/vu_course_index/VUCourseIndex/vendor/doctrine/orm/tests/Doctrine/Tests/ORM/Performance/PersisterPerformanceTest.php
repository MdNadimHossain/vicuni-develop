...
class PersisterPerformanceTest extends \Doctrine\Tests\OrmFunctionalTestCase {
  ...
  public function testFindCmsArticle() {
    ...
    $articles = $this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsArticle')
      ->findAll();
  ...
  public function testFindCmsGroup() {
    ...
    $start = microtime(TRUE);
    $articles = $this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsGroup')
      ->findAll();
  ...
  public function testFindCmsUser() {
    ...
    $start = microtime(TRUE);
    $articles = $this->_em->getRepository('Doctrine\Tests\Models\CMS\CmsUser')
      ->findAll();
