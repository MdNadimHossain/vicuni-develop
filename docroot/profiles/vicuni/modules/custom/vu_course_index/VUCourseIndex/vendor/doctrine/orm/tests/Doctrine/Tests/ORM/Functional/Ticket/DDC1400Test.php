...
class DDC1400Article {
  ...
  /**
   * @OneToMany(targetEntity="DDC1400UserState", mappedBy="article",
   *   indexBy="userId", fetch="EXTRA_LAZY")
   */
  public $userStates;
}
...
class DDC1400User {
  ...
  /**
   * @OneToMany(targetEntity="DDC1400UserState", mappedBy="user",
   *   indexBy="articleId", fetch="EXTRA_LAZY")
   */
  public $userStates;
}
