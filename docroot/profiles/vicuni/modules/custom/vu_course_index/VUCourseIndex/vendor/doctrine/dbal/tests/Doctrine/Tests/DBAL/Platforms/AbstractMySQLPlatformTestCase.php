...
abstract class AbstractMySQLPlatformTestCase extends AbstractPlatformTestCase {
  ...
  public function testReturnsBinaryTypeDeclarationSQL() {
    ...
    $this->assertSame('BINARY(255)', $this->_platform->getBinaryTypeDeclarationSQL(array(
      'fixed' => TRUE,
      'length' => 0
    )));
    $this->assertSame('BINARY(65535)', $this->_platform->getBinaryTypeDeclarationSQL(array(
      'fixed' => TRUE,
      'length' => 65535
    )));
    $this->assertSame('MEDIUMBLOB', $this->_platform->getBinaryTypeDeclarationSQL(array(
      'fixed' => TRUE,
      'length' => 65536
    )));
    $this->assertSame('MEDIUMBLOB', $this->_platform->getBinaryTypeDeclarationSQL(array(
    ...
    $this->assertSame('LONGBLOB', $this->_platform->getBinaryTypeDeclarationSQL(array(
      'fixed' => TRUE,
      'length' => 16777216
    )));
  }
  ...
  public function testDoesNotPropagateDefaultValuesForUnsupportedColumnTypes() {
    ...
    $table->addColumn('def_text_null', 'text', array(
      'notnull' => FALSE,
      'default' => 'def'
    ));
    $table->addColumn('def_blob', 'blob', array('default' => 'def'));
    $table->addColumn('def_blob_null', 'blob', array(
      'notnull' => FALSE,
      'default' => 'def'
    ));
