...
abstract class AbstractFileLoader implements FileLoaderInterface {
  ...
  /**
   * Indicate whether or not to use the include_path to resolve translation
   * files
   *
   * @param bool $flag
   *
   ...
   *
   * Checks if the file exists and is readable, returning a boolean false if
   * not; if the "useIncludePath" flag is enabled, it will attempt to resolve
   * the file from the include_path if the file does not exist on the current
   * working path.
   *
