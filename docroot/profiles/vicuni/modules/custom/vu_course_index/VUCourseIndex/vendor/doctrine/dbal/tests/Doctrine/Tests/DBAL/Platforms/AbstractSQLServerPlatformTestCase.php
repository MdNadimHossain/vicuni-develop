...
abstract class AbstractSQLServerPlatformTestCase extends AbstractPlatformTestCase {
  ...
  public function testReturnsBinaryTypeDeclarationSQL() {
    ...
    $this->assertSame('BINARY(8000)', $this->_platform->getBinaryTypeDeclarationSQL(array(
      'fixed' => TRUE,
      'length' => 8000
    )));
    $this->assertSame('VARBINARY(MAX)', $this->_platform->getBinaryTypeDeclarationSQL(array(
      'fixed' => TRUE,
      'length' => 8001
    )));
  }
