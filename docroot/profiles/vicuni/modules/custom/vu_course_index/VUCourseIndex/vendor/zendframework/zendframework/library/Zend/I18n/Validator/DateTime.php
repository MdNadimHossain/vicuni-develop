...
class DateTime extends AbstractValidator {
   ...
   *
   * @throws I18nException\ExtensionNotLoadedException if ext/intl is not
   *   present
   */
  ...
  public function getCalendar() {
    return ($this->formatter && !$this->invalidateFormatter) ? $this->getIntlDateFormatter()
  ...
  /**
   * Returns the timezone used by the IntlDateFormatter or the system default
   * if none given
   *
   * @return string
   */
  ...
  /**
   * Returns the locale used by the IntlDateFormatter or the system default if
   * none given
   *
   * @return string
   */
