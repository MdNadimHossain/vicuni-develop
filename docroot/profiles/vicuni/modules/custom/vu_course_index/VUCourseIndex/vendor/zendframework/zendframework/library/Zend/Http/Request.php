...
class Request extends AbstractMessage implements RequestInterface {
  ...
  /**
   * A factory that produces a Request object from a well-formed Http Request
   * string
   *
   * @param  string $string
   *
  ...
  /**
   * Provide an alternate Parameter Container implementation for query
  ...
  /**
   * Return the parameter container responsible for query parameters or a
  ...
  /**
   * Provide an alternate Parameter Container implementation for post
   * parameters in this object,
  ...
  /**
   * Provide an alternate Parameter Container implementation for file
   * parameters in this object,
  ...
  /**
   * Return the parameter container responsible for file parameters or a single
   * file.
   *
   * @param string|null $name Parameter name to retrieve, or null to get the
   *   whole container.
  ...
  /**
   * Return the header container responsible for headers or all headers of a
   * certain name/type
   *
   * @see \Zend\Http\Headers::get()
   *
   * @param string|null $name Header name to retrieve, or null to get the whole
   *   container.
   * @param mixed|null $default Default value to use when the requested header
   *   is missing.
   *
