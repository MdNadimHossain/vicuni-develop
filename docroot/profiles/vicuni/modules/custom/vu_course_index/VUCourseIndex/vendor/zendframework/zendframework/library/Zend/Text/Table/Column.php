...
class Column {
   ...
   *
   * @throws Exception\InvalidArgumentException When $columnWidth is lower than
   *   1
   * @throws Exception\OutOfBoundsException When padding is greater than
   *   columnWidth
   * @return string
   */
