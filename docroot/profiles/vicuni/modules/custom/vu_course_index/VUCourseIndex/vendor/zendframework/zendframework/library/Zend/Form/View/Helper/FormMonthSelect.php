...
class FormMonthSelect extends AbstractHelper {
   ...
   * NOTE: we don't use a pattern for years, as years written as two digits can
   * lead to hard to read date for users, so we only use four digits years
   *
   * @param int $minYear
   * @param int $maxYear
   *
