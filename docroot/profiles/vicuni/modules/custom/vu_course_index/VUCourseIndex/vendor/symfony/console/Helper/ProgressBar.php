...
class ProgressBar {
   ...
   *
   * @param string $name The placeholder name (including the delimiter char
   *   like %)
   ...
   *
   * @deprecated since version 2.6, to be removed in 3.0. Use {@link
   *   getProgress()} instead.
   *
   ...
   *
   * @internal This method is public for PHP 5.3 compatibility, it should not
   *   be used.
   *
   ...
   *
   * @param int|null $max Number of steps to complete the bar (0 if
   *   indeterminate), null to leave unchanged
   */
