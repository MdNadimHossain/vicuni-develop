 ...
 * registered work with the annotation values, as well as the element and input
...
class ElementAnnotationsListener extends AbstractAnnotationsListener {
  ...
  public function attach(EventManagerInterface $events) {
    $this->listeners[] = $events->attach('configureElement', array(
      $this,
    ...
    $this->listeners[] = $events->attach('discoverName', array(
      $this,
    ...
    $this->listeners[] = $events->attach('checkForExclude', array(
      $this,
