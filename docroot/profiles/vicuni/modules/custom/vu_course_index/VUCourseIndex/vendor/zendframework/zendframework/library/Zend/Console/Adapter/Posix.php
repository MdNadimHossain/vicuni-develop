...
class Posix extends AbstractAdapter {
  ...
  /**
   * Write a single line of text to console and advance cursor to the next
   * line.
   *
   * This override works around a bug in some terminals that cause the
   * background color to fill the next line after EOL. To remedy this, we are
   * sending the colored string with appropriate color reset sequences before
   * sending EOL character.
   *
