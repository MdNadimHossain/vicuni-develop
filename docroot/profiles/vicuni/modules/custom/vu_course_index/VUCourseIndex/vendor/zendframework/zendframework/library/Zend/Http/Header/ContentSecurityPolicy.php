...
class ContentSecurityPolicy implements HeaderInterface {
   ...
   *
   * @return self
   * @throws Exception\InvalidArgumentException If the name is not a valid
   *   directive name.
   */
   ...
   *
   * @return self
   * @throws Exception\InvalidArgumentException If the name field in the given
   *   header line does not match.
   */
