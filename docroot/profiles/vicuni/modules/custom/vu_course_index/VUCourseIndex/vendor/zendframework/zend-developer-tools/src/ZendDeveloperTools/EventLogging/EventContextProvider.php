...
class EventContextProvider implements EventContextInterface {
  ...
  /**
   * @param EventInterface $event (Optional) The event to provide context to.
   *   The event must be set either here or with {@see setEvent()} before any
  ...
  /**
   * Returns the debug_backtrace() for this object with two levels removed so
   * that array starts where this class method was called.
   *
   * @return string
   */
  ...
  /**
   * Returns the filename and parent directory of the file from which the event
   * was triggered.
   *
   * @return string
   */
