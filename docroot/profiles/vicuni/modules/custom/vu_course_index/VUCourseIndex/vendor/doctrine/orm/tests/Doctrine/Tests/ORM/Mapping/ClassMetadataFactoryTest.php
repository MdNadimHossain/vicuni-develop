...
class ClassMetadataFactoryTest extends \Doctrine\Tests\OrmTestCase {
  ...
  public function testIsTransient() {
    ...
    $this->assertTrue($em->getMetadataFactory()
      ->isTransient('Doctrine\Tests\Models\CMS\CmsUser'));
    $this->assertFalse($em->getMetadataFactory()
      ->isTransient('Doctrine\Tests\Models\CMS\CmsArticle'));
  }
