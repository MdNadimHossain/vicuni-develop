...
class CommandTest extends \PHPUnit_Framework_TestCase {
   ...
   * @expectedExceptionMessage The command defined in
   *   "Symfony\Component\Console\Command\Command" cannot have an empty name.
   */
  ...
  public function testMergeApplicationDefinition() {
    ...
    $application1->getDefinition()
      ->addArguments(array(new InputArgument('foo')));
  ...
  /**
   * @expectedException        \LogicException
   * @expectedExceptionMessage You must override the execute() method in the
