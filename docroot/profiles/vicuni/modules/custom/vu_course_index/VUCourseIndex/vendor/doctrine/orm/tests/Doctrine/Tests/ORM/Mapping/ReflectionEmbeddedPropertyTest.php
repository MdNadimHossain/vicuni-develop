...
class ReflectionEmbeddedPropertyTest extends \PHPUnit_Framework_TestCase {
  /**
   * @param ReflectionProperty $parentProperty property of the
   *   embeddable/entity where to write the embeddable to
   * @param ReflectionProperty $childProperty property of the embeddable class
   *   where to write values to
   * @param string $embeddableClass name of the embeddable class to be
   *   instantiated
   *
  ...
  public function testCanSetAndGetEmbeddedProperty(
    ...
    $object = $instantiator->instantiate($parentProperty->getDeclaringClass()
      ->getName());
  ...
  public function testWillSkipReadingPropertiesFromNullEmbeddable(
    ...
    $this->assertNull($embeddedPropertyReflection->getValue(
      $instantiator->instantiate($parentProperty->getDeclaringClass()
        ->getName())
    ));
  }
