...
EOT;
  ...
  /**
   * A template for message to show in console when an exception has previous
   * exceptions.
   *
   * @var string
   */
...
EOT;
  ...
  public function attach(EventManagerInterface $events) {
    ...
    $this->listeners[] = $events->attach(MvcEvent::EVENT_RENDER_ERROR, array(
      $this,
      'prepareExceptionViewModel'
    ));
  }
   ...
   *
   * The closure is expected to return a string and will be called with 2
   * parameters: Exception $exception           - the exception being thrown
