...
class YamlMappingDriverTest extends AbstractMappingDriverTest {
  ...
  public function testJoinTablesWithMappedSuperclassForYamlDriver() {
    ...
    $yamlDriver->getLocator()
      ->addPaths(array(__DIR__ . DIRECTORY_SEPARATOR . 'yaml'));
   ...
   * @expectedExceptionMessage Invalid mapping file
   *   'Doctrine.Tests.Models.Generic.SerializationModel.dcm.yml' for class
