...
class Server implements ZendServerServer {
  ...
  /**
   * Array of SOAP type => PHP class pairings for handling return/incoming
   * values
   *
   * @var array
   */
  ...
  /**
   * Flag: whether or not {@link handle()} should return a response instead of
   * automatically emitting it.
   *
   * @var bool
   */
   ...
   *
   * @return self
   * @throws Exception\InvalidArgumentException with invalid soap version
   *   argument
   */
   ...
   * Set URI
   *
   * URI in SoapServer is actually the target namespace, not a URI; $uri must
   * begin with 'urn:'.
   *
   * @param  string $uri
   *
   ...
   *
   * @return self
   * @throws Exception\InvalidArgumentException for any invalid class in the
   *   class map
   */
   ...
   *
   * @param  array|string $function Function name, array of function names to
   *   attach, or SOAP_FUNCTIONS_ALL to attach all functions
   ...
   *
   * See {@link setObject()} to set pre-configured object instances as request
   * handlers.
   *
   ...
   *
   * @return self
   * @throws Exception\InvalidArgumentException if called more than once, or if
   ...
   *
   * @param  int $mode SOAP_PERSISTENCE_SESSION or SOAP_PERSISTENCE_REQUEST
   *   constants
   *
   * @return self
   * @throws Exception\InvalidArgumentException
   ...
   *
   * @param  DOMDocument|DOMNode|SimpleXMLElement|\stdClass|string $request Optional
   *   request
   *
   * @return void|string
   */
  ...
  /**
   * Method initializes the error context that the SOAPServer environment will
   * run in.
   *
