...
class Collection extends Fieldset {
  ...
  /**
   * Placeholder used in template content for making your life easier with
   * JavaScript
   *
   * @var string
   */
   ...
   * - allow_add: if set to true, elements can be added to the form dynamically
   * (using JavaScript)
   * - allow_remove: if set to true, elements can be removed to the form
   * - should_create_template: if set to true, a template is generated (inside
   * a <span>)
  ...
  /**
   * If set to true, a template prototype is automatically added to the form to
   * ease the creation of dynamic elements through JavaScript
   *
  ...
  /**
   * Set the placeholder used in the template generated to help create new
  ...
  /**
   * Prepare the collection by adding a dummy template element if the user want
   * one
   *
  ...
  /**
   * Replaces the default template object of a sub element with the
   * corresponding real entity so that all properties are preserved.
   *
   * @return void
   */
