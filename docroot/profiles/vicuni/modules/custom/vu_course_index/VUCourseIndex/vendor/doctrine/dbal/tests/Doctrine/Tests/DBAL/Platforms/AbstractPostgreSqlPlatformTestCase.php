...
abstract class AbstractPostgreSqlPlatformTestCase extends AbstractPlatformTestCase {
  ...
  public function testGeneratesForeignKeySqlForNonStandardOptions() {
    ...
    $foreignKey = new \Doctrine\DBAL\Schema\ForeignKeyConstraint(
      array('foreign_id'), 'my_table', array('id'), 'my_fk', array(
        'deferrable' => TRUE,
        'deferred' => TRUE,
        'match' => 'full'
      )
  ...
  public function testThrowsExceptionWithInvalidBooleanLiteral() {
    $platform = $this->createPlatform()
      ->convertBooleansToDatabaseValue("my-bool");
  }
  ...
  public function testAlterDecimalPrecisionScale() {
    ...
    $table->addColumn('dfoo2', 'decimal', array(
      'precision' => 10,
      'scale' => 6
    ));
    $table->addColumn('dfoo3', 'decimal', array(
      'precision' => 10,
      'scale' => 6
    ));
    $table->addColumn('dfoo4', 'decimal', array(
      'precision' => 10,
      'scale' => 6
    ));
    ...
    $tableDiff->changedColumns['dloo1'] = new \Doctrine\DBAL\Schema\ColumnDiff(
      ...
      'dloo1', \Doctrine\DBAL\Types\Type::getType('decimal'), array(
        'precision' => 16,
        'scale' => 6
      )
    ),
    ...
    $tableDiff->changedColumns['dloo2'] = new \Doctrine\DBAL\Schema\ColumnDiff(
      ...
      'dloo2', \Doctrine\DBAL\Types\Type::getType('decimal'), array(
        'precision' => 10,
        'scale' => 4
      )
    ),
    ...
    $tableDiff->changedColumns['dloo3'] = new \Doctrine\DBAL\Schema\ColumnDiff(
      ...
      'dloo3', \Doctrine\DBAL\Types\Type::getType('decimal'), array(
        'precision' => 10,
        'scale' => 6
      )
    ),
    ...
    $tableDiff->changedColumns['dloo4'] = new \Doctrine\DBAL\Schema\ColumnDiff(
      ...
      'dloo4', \Doctrine\DBAL\Types\Type::getType('decimal'), array(
        'precision' => 16,
        'scale' => 8
      )
    ),
  ...
  public function testDoesNotPropagateUnnecessaryTableAlterationOnBinaryType() {
    ...
    $table2->addColumn('column_blob', 'binary', array(
      'length' => 11,
      'fixed' => TRUE
    ));
    ...
    $table2->addColumn('column_binary', 'binary', array(
      'length' => 42,
      'fixed' => TRUE
    ));
