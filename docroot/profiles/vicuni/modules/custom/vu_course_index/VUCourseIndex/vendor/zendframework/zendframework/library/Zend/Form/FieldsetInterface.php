...
interface FieldsetInterface extends
   ...
   *
   * @param  array|\Traversable|ElementInterface $elementOrFieldset Typically,
   *   only allow objects implementing ElementInterface; however, keeping it
   *   flexible to allow a factory-based form implementation as well
   * @param  array $flags
   *
