/**
 * @file
 * Enhancements for Mid-Year Intake node type forms.
 */

(function ($) {
  'use strict';

  Drupal.behaviors.courseMidYearIntake = {
    attach: function (context) {
      // Provide the vertical tab summaries.
      $('fieldset#edit-midyear-intake', context).drupalSetSummary(function (context) {
        var vals = [];
